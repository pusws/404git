...
<body>
<div class="header">
  <h1>VLESS 代理 V25.5.27</h1>
  <p>Cloudflare Workers 代理服务</p>
</div>

<div class="container">
  <!-- Note Tile -->
  <div class="tile note-section tile-wide">
    <div class="tile-title">使用说明</div>
    <div class="tile-subtitle">${noteshow}</div>
  </div>
  
  <!-- Non-TLS Tile -->
  <div class="tile tile-blue tile-large live-tile" data-badge="1" onclick="showModal('非TLS节点', '${w\u0076\u006c\u0065\u0073\u0073ws}')">
    <div class="tile-icon">🌐</div>
    <div class="tile-title">非TLS节点</div>
    <div class="tile-subtitle">无视域名阻断</div>
  </div>
  
  <!-- TLS Tile -->
  <div class="tile tile-green tile-large live-tile" data-badge="2" onclick="showModal('TLS节点', '${p\u0076\u006c\u0065\u0073\u0073wstls}')">
    <div class="tile-icon">🔒</div>
    <div class="tile-title">TLS节点</div>
    <div class="tile-subtitle">加密传输</div>
  </div>
  
  <!-- Universal Share Tile -->
  <div class="tile tile-orange tile-wide" onclick="showModal('通用分享链接', '${wk\u0076\u006c\u0065\u0073\u0073share}')">
    <div class="tile-icon">📋</div>
    <div class="tile-title">通用分享链接</div>
    <div class="tile-subtitle">13个端口节点</div>
  </div>
  
  <!-- Universal Subscription Tile -->
  <div class="tile tile-purple tile-wide" onclick="showModal('通用订阅链接', '${ty}')">
    <div class="tile-icon">📱</div>
    <div class="tile-title">通用订阅</div>
    <div class="tile-subtitle">一键导入客户端</div>
  </div>
  
  <!-- Clash Subscription Tile -->
  <div class="tile tile-teal tile-wide" onclick="showModal('Clash-meta订阅', '${cl}')">
    <div class="tile-icon">⚡</div>
    <div class="tile-title">Clash-meta订阅</div>
    <div class="tile-subtitle">高性能代理</div>
  </div>
  
  <!-- Sing-box Subscription Tile -->
  <div class="tile tile-pink tile-wide" onclick="showModal('Sing-box订阅', '${sb}')">
    <div class="tile-icon">📦</div>
    <div class="tile-title">Sing-box订阅</div>
    <div class="tile-subtitle">通用代理平台</div>
  </div>
  
  <!-- Info Tile -->
  <div class="tile tile-blue tile-tall" onclick="showModal('客户端参数', '客户端地址：自定义域名或优选IP\\n端口：HTTP(80,8080,8880,2052,2082,2086,2095)\\nHTTPS(443,8443,2053,2083,2087,2096)\\n用户ID：${userID}\\n传输协议：ws\\n伪装域名：${hostName}\\n路径：/?ed=2560')">
    <div class="tile-icon">ℹ️</div>
    <div class="tile-title">配置参数</div>
    <div class="tile-subtitle">查看详细参数</div>
  </div>
</div>
...
<div class="header">
  <h1>VLESS 代理 V25.5.27</h1>
  <p>Cloudflare Pages/自定义域名 代理服务</p>
</div>
...
<div class="container">
  ...
  <!-- TLS Tile -->
  <div class="tile tile-green tile-large live-tile" data-badge="1" onclick="showModal('TLS节点', '${p\u0076\u006c\u0065\u0073\u0073wstls}')">
    <div class="tile-icon">🔒</div>
    <div class="tile-title">TLS节点</div>
    <div class="tile-subtitle">加密传输</div>
  </div>
  ...
  <!-- Universal Share Tile -->
  <div class="tile tile-orange tile-large live-tile" data-badge="2" onclick="showModal('通用分享链接', '${pg\u0076\u006c\u0065\u0073\u0073share}')">
    <div class="tile-icon">📋</div>
    <div class="tile-title">通用分享链接</div>
    <div class="tile-subtitle">6个TLS端口节点</div>
  </div>
  
  <!-- Universal Subscription Tile -->
  <div class="tile tile-purple tile-wide" onclick="showModal('通用订阅链接', '${pty}')">
    <div class="tile-icon">📱</div>
    <div class="tile-title">通用订阅</div>
    <div class="tile-subtitle">一键导入客户端</div>
  </div>
  ...
  <!-- Clash Subscription Tile -->
  <div class="tile tile-teal tile-wide" onclick="showModal('Clash-meta订阅', '${pcl}')">
    <div class="tile-icon">⚡</div>
    <div class="tile-title">Clash-meta订阅</div>
    <div class="tile-subtitle">高性能代理</div>
  </div>
  ...
  <!-- Sing-box Subscription Tile -->
  <div class="tile tile-pink tile-wide" onclick="showModal('Sing-box订阅', '${psb}')">
    <div class="tile-icon">📦</div>
    <div class="tile-title">Sing-box订阅</div>
    <div class="tile-subtitle">通用代理平台</div>
  </div>
  ...
  <!-- Info Tile -->
  <div class="tile tile-blue tile-tall" onclick="showModal('客户端参数', '客户端地址：自定义域名或优选IP\\n端口：HTTPS(443,8443,2053,2083,2087,2096)\\n用户ID：${userID}\\n传输协议：ws\\n伪装域名：${hostName}\\n路径：/?ed=2560\\n传输安全：TLS开启')">
    <div class="tile-icon">ℹ️</div>
    <div class="tile-title">配置参数</div>
    <div class="tile-subtitle">查看详细参数</div>
  </div>
