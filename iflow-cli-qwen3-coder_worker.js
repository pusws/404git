...
.tile-yellow { background-color: #ffb900; color: #000; }
.tile-yellow h3, .tile-yellow p { color: #000; }
.tile-yellow .copy-btn { color: #000; background: rgba(0, 0, 0, 0.1); }
.tile-yellow .copy-btn:hover { background: rgba(0, 0, 0, 0.2); }
...
<div class="container">
  <div class="header">
    <h1>Cloudflare Workers VLESS 代理脚本</h1>
    <p>V25.5.27</p>
  </div>
  
  <div class="metro-grid">
    <div class="metro-tile tile-blue">
      <h3>CF Workers VLESS + WS</h3>
      <p>关闭了TLS加密，无视域名阻断</p>
      <button class="copy-btn" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-green">
      <h3>CF Workers VLESS + WS + TLS</h3>
      <p>启用了TLS加密，如果客户端支持分片功能，建议开启防止域名阻断</p>
      <button class="copy-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-orange live-tile">
      <h3>通用分享链接</h3>
      <p>可直接导入客户端，包含TLS+非TLS共13个端口节点</p>
      <button class="copy-btn" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制链接</button>
      <div class="notification">13</div>
    </div>
    
    <div class="metro-tile tile-purple">
      <h3>通用订阅链接</h3>
      <p>聚合通用订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${ty}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-teal">
      <h3>Clash-meta 订阅</h3>
      <p>Clash-meta订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${cl}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-red">
      <h3>Sing-box 订阅</h3>
      <p>Sing-box订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${sb}')">复制链接</button>
    </div>
  </div>
  
  <div class="parameters">
    <h3>CF Workers VLESS + WS 节点参数</h3>
    <ul>
  ...
  <div class="parameters">
    <h3>CF Workers VLESS + WS + TLS 节点参数</h3>
    <ul>
      <li>客户端地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
  ...
  <div class="footer">
    <p>${noteshow}</p>
    <p>注意：默认每个订阅链接包含TLS+非TLS共13个端口节点。当前workers域名作为订阅链接，需通过代理进行订阅更新。如使用的客户端不支持分片功能，则TLS节点不可用。</p>
  </div>
</div>
</body>
`;
...
<div class="container">
  ...
  <div class="metro-grid">
    <div class="metro-tile tile-blue">
      <h3>CF Pages/Workers 自定义域 VLESS + WS + TLS</h3>
      <p>启用了TLS加密，如果客户端支持分片功能，可开启防止域名阻断</p>
      <button class="copy-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-orange live-tile">
      <h3>通用分享链接</h3>
      <p>可直接导入客户端，仅6个TLS端口节点</p>
      <button class="copy-btn" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制链接</button>
    ...
    <div class="metro-tile tile-purple">
      <h3>通用订阅链接</h3>
      <p>聚合通用订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${pty}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-teal">
      <h3>Clash-meta 订阅</h3>
      <p>Clash-meta订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${pcl}')">复制链接</button>
    </div>
    
    <div class="metro-tile tile-red">
      <h3>Sing-box 订阅</h3>
      <p>Sing-box订阅链接</p>
      <button class="copy-btn" onclick="copyToClipboard('${psb}')">复制链接</button>
    </div>
  </div>
  
  <div class="parameters">
    <h3>CF Pages/Workers 自定义域 VLESS + WS + TLS 节点参数</h3>
    <ul>
      <li>客户端地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
      <li>端口(port)：6个https端口可任意选择(443、8443、2053、2083、2087、2096)，或反代IP对应端口</li>
      <li>用户ID(uuid)：${userID}</li>
