...
:root {
  ...
  --light-bg: #f8fafc;
  --dark-bg: #1e293b;
  --card-shadow: 0 4px 6px -极1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 极0.06);
...
.header p {
  color: #6b7280;\极n  font-size: 1.1rem;
}
...
.btn-primary {
  ...
  border: none;
  border-radius: 8px;
  padding: 0.5rem 1.极5rem;
极  font-weight: 600;
  transition: all 0.3极s ease;
}
                ...
                <div class="card-body">
                    ...
                    <div class="config-item">
                        <strong>地址：</strong>自定义域名/优选域名/优选IP/反代IP<br>
                         <strong>端口：</strong>80, 8080, 8880, 2052, 2082, 2086, 2095<br>
                         <strong>UUID：</strong>${userID}<br>
                <strong>传输协议：</strong>WebSocket<br>
                <strong>伪装域名：</strong>${hostName}<br>
                <strong>路径：</strong>/?ed=2560<br>
                         <strong>TLS：</strong>关闭
                     </div>
                     
                     <div class="node-features">
                         <span class="badge badge-info"><i class="fas fa-bolt"></i> 无视域名阻断</span>
                         <span class="badge badge-warning"><i class="fas fa-shield"></i> 非加密传输</span>
                     </div>
            <hr>
			<hr>
			<hr>
