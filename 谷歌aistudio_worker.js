...
<head>
  ...
  <title>Cloudflare VLESS 配置</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; }
    .card { backdrop-filter: blur(10px); background-color: rgba(33, 37, 41, 0.75); border: 1px solid rgba(255, 255, 255, 0.1); }
    .input-group .form-control { word-break: break-all; }
    .btn-copy .bi-check-lg { display: none; }
    .btn-copy.copied .bi-clipboard { display: none; }
    .btn-copy.copied .bi-check-lg { display: inline-block; }
    .config-list .list-group-item { background-color: transparent; border-color: rgba(255, 255, 255, 0.1); }
    .config-list code { color: #f8f9fa; background-color: rgba(255,255,255,0.1); padding: 0.2em 0.4em; border-radius: 3px; }
  </style>
</head>
<body>
  <div class="container py-5">
    <header class="text-center mb-5">
      <h1 class="display-5 fw-bold">Cloudflare VLESS 代理配置</h1>
      <p class="lead text-white-50">V25.5.27 | NAT64 自动代理</p>
    </header>

    <div class="card mb-4">
      <div class="card-body">
        <h5 class="card-title"><i class="bi bi-info-circle-fill me-2"></i>作者信息与说明</h5>
        <p class="card-text small">${note.replace(/\n/g, '<br>')}</p>
      </div>
    </div>
    ...
    ${hostName.includes("workers.dev") ? `
      ...
      <div class="row">
        <div class="col-lg-6 mb-4">
          <div class="card h-100">
            <div class="card-header fw-bold"><i class="bi bi-shield-slash me-2"></i>VLESS + WS (非-TLS) 节点</div>
            <div class="card-body">
              <h6 class="card-subtitle mb-2 text-warning"><i class="bi bi-exclamation-triangle-fill me-2"></i>无加密，抗域名阻断</h6>
              <ul class="list-group list-group-flush config-list small mt-3">
                  <li class="list-group-item d-flex justify-content-between"><span>地址 (Address)</span><code>${CDNIP}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>端口 (Port)</span><code>80, 8080, 8880, 2052, 2082, 2086, 2095</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>用户ID (UUID)</span><code>${userID}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>传输协议 (Network)</span><code>ws</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>伪装域名 (Host)</span><code>${hostName}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>路径 (Path)</span><code>/?ed=2560</code></li>
              </ul>
            </div>
            <div class="card-footer">
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${wVlessws}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${wVlessws}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card h-100">
            <div class="card-header fw-bold"><i class="bi bi-shield-lock me-2"></i>VLESS + WS + TLS 节点</div>
            <div class="card-body">
              <h6 class="card-subtitle mb-2 text-info"><i class="bi bi-shield-check me-2"></i>TLS 加密，建议开启 Fragment</h6>
              <ul class="list-group list-group-flush config-list small mt-3">
                  <li class="list-group-item d-flex justify-content-between"><span>地址 (Address)</span><code>${CDNIP}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>端口 (Port)</span><code>443, 8443, 2053, 2083, 2087, 2096</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>用户ID (UUID)</span><code>${userID}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>传输协议 (Network)</span><code>ws</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>伪装域名 (Host)</span><code>${hostName}</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>路径 (Path)</span><code>/?ed=2560</code></li>
                  <li class="list-group-item d-flex justify-content-between"><span>SNI</span><code>${hostName}</code></li>
              </ul>
            </div>
            <div class="card-footer">
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${pVlesswstls}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${pVlesswstls}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-header fw-bold"><i class="bi bi-link-45deg me-2"></i>聚合订阅链接 (包含以上所有13个节点)</div>
        <div class="card-body">
            <div class="mb-3">
                <label class="form-label small">通用分享链接 (Base64)</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${wkShare}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${wkShare}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label small">通用订阅链接</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${ty}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${ty}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label small">Clash-Meta 订阅</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${cl}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${cl}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div>
                <label class="form-label small">Sing-Box 订阅</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${sb}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${sb}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
        </div>
      </div>
    ` : `
      ...
      <div class="card">
        <div class="card-header fw-bold"><i class="bi bi-link-45deg me-2"></i>聚合订阅链接 (仅包含以上6个TLS节点)</div>
        <div class="card-body">
            <div class="mb-3">
                <label class="form-label small">通用分享链接 (Base64)</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${pgShare}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${pgShare}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label small">通用订阅链接</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${pty}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${pty}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label small">Clash-Meta 订阅</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${pcl}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${pcl}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
            <div>
                <label class="form-label small">Sing-Box 订阅</label>
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm" value="${psb}" readonly>
                    <button class="btn btn-outline-secondary btn-copy" onclick="copyToClipboard(this, '${psb}')"><i class="bi bi-clipboard"></i><i class="bi bi-check-lg"></i></button>
                </div>
            </div>
        </div>
      </div>
