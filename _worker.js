...
:root {
  ...
  --gh-text-link: #58a6ff;
  --gh-accent-primary: #238636;
  --gh-accent-secondary: #1f6feb;
  --gh-danger: #da3633;
  --gh-warning: #d29922;
  --gh-success: #238636;
}
...
.btn-primary {
  color: #ffffff;
  background-color: var(--gh-accent-secondary);
  border-color: var(--gh-accent-secondary);
}
...
.section-divider {
  margin: 32px 0;
  height: 2px;
  background: linear-gradient(90deg, var(--gh-border-primary) 0%, transparent 100%);
  border: none;
}
...
.note-box {
  background-color: var(--gh-bg-tertiary);
  border: 1px solid var(--gh-border-primary);
  border-left: 4px solid var(--gh-accent-secondary);
...
.btn:focus,
button:focus {
  outline: 2px solid var(--gh-accent-secondary);
  outline-offset: 2px;
}
...
<body>
<div class="container">
    <h1>🚀 Cloudflare Workers VLESS 代理配置面板</h1>
    ...
    <div class="card">
        <div class="card-header">
            <h3>📡 CF-Workers VLESS+WS 节点</h3>
            <span class="feature-badge">无 TLS 加密</span>
        </div>
        <div class="card-body">
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>关闭了TLS加密，无视域名阻断</td>
                            <td class="limited-width">${w\u0076\u006c\u0065\u0073\u0073ws}</td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制链接</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <ul>
                ...
                <li><strong>用户ID(uuid)：</strong><code>${userID}</code></li>
                <li><strong>传输协议(network)：</strong>ws 或者 websocket</li>
                <li><strong>伪装域名(host)：</strong><code>${hostName}</code></li>
                <li><strong>路径(path)：</strong><code>/?ed=2560</code></li>
    ...
    <div class="card">
        <div class="card-header">
            <h3>🔒 CF-Workers VLESS+WS+TLS 节点</h3>
            <span class="feature-badge">TLS 加密</span>
        </div>
        <div class="card-body">
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>启用了TLS加密<br><small>如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</small></td>
                            <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                            <td><button class="btn btn-success" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3>📱 订阅链接配置</h3>
            <span class="feature-badge">多协议支持</span>
        </div>
        <div class="card-body">
            <div class="note-box">
                <p><strong>⚠️ 注意事项：</strong><br>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td><strong>聚合通用分享链接</strong><br><small>可直接导入客户端</small></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button></td>
                            <td>-</td>
                        </tr>
                        <tr>
                            <td><strong>聚合通用订阅</strong></td>
                            <td class="limited-width"><a href="${ty}" class="config-link">${ty}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${ty}')">复制链接</button></td>
                        </tr>
                        <tr>
                            <td><strong>Clash Meta 订阅</strong></td>
                            <td class="limited-width"><a href="${cl}" class="config-link">${cl}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${cl}')">复制链接</button></td>
                        </tr>
                        <tr>
                            <td><strong>Sing-box 订阅</strong></td>
                            <td class="limited-width"><a href="${sb}" class="config-link">${sb}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${sb}')">复制链接</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<body>
<div class="container">
    <h1>🌐 Cloudflare Pages VLESS 代理配置面板</h1>
    ...
    <div class="card">
        <div class="card-header">
            <h3>🔒 CF-Pages VLESS+WS+TLS 节点</h3>
            <span class="feature-badge">TLS 加密</span>
        </div>
        <div class="card-body">
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>启用了TLS加密<br><small>如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</small></td>
                            <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                            <td><button class="btn btn-success" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button></td>
                        </tr>
                    </tbody>
    ...
    <div class="card">
        <div class="card-header">
            <h3>📱 订阅链接配置</h3>
            <span class="feature-badge">TLS 端口节点</span>
        </div>
        <div class="card-body">
            <div class="note-box">
                <p><strong>⚠️ 注意事项：</strong>以下订阅链接仅包含6个TLS端口节点</p>
            </div>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td><strong>聚合通用分享链接</strong><br><small>可直接导入客户端</small></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button></td>
                            <td>-</td>
                        </tr>
                        <tr>
                            <td><strong>聚合通用订阅</strong></td>
                            <td class="limited-width"><a href="${pty}" class="config-link">${pty}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${pty}')">复制链接</button></td>
                        </tr>
                        <tr>
                            <td><strong>Clash Meta 订阅</strong></td>
                            <td class="limited-width"><a href="${pcl}" class="config-link">${pcl}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${pcl}')">复制链接</button></td>
                        </tr>
                        <tr>
                            <td><strong>Sing-box 订阅</strong></td>
                            <td class="limited-width"><a href="${psb}" class="config-link">${psb}</a></td>
                            <td><button class="btn btn-primary" onclick="copyToClipboard('${psb}')">复制链接</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
