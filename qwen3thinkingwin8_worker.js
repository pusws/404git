...
<head>
    ...
    <title>Cloudflare VLESS 代理</title>
    <style>
        @font-face {
        ...
        * {
        ...
        .color-accent {
            background: linear-gradient(135deg, #d83b01, #a4262c);
        }
        
        .color-purple {
            background: linear-gradient(135deg, #6200ea, #3d00b0);
        }
...
<body>
    <div class="metro-container">
        <div class="header">
            ...
            <p>甬哥博客地址：https://ygkkk.blogspot.com | 甬哥YouTube频道：https://www.youtube.com/@ygkkk</p>
        </div>
        
        <div class="grid">
            <!-- 项目信息磁贴 -->
            <div class="tile color-purple tile-large">
                <div class="tile-content">
                    <div class="tile-title">
                        <i>ℹ️</i>
                        <h2>项目信息</h2>
                    </div>
                    <p>本项目基于Cloudflare Workers提供VLESS代理服务，支持WebSocket传输协议。自动处理NAT64转换，无需手动设置proxyip。</p>
                    <div class="info-section">
                        <strong>注意：</strong> ProxyIP使用nat64自动生成，无需设置
                    </div>
                    <p>支持workers.dev域名和自定义域名两种部署方式，提供多种客户端配置格式。</p>
                </div>
            </div>
            
            <!-- 非TLS节点磁贴 -->
            ${hostName.includes("workers.dev") ? `
            <div class="tile color-secondary">
                <div class="tile-content">
                    <div class="tile-title">
                        <i>🌐</i>
                        <h2>非TLS节点</h2>
                    </div>
                    <p>关闭了TLS加密，无视域名阻断，适用于workers.dev域名</p>
                    <div class="link-container">${w\u0076\u006c\u0065\u0073\u0073ws}</div>
                    <button class="copy-btn" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制节点链接</button>
                    <p class="note">端口：7个http端口可任意选择(80、8080、8880、2052、2082、2086、2095)</p>
                </div>
            </div>
            ` : ''}
            
            <!-- TLS节点磁贴 -->
            <div class="tile color-primary ${hostName.includes("workers.dev") ? '' : 'tile-large'}">
                <div class="tile-content">
                    <div class="tile-title">
                        <i>🔒</i>
                        <h2>TLS节点</h2>
                    </div>
                    <p>启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</p>
                    <div class="link-container">${p\u0076\u006c\u0065\u0073\u0073wstls}</div>
                    <button class="copy-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制节点链接</button>
                    <p class="note">端口：6个https端口可任意选择(443、8443、2053、2083、2087、2096)</p>
                </div>
            </div>
            
            <!-- 订阅链接磁贴 -->
            <div class="tile color-accent tile-wide">
                <div class="tile-content">
                    <div class="tile-title">
                        <i>🔗</i>
                        <h2>订阅链接</h2>
                    </div>
                    <p>聚合通用、Clash-meta、Sing-box订阅链接</p>
                    
                    <div style="margin: 15px 0;">
                        <div style="display: flex; margin-bottom: 10px;">
                            <span style="width: 120px; font-weight: bold;">通用订阅:</span>
                            <div class="link-container" style="flex-grow: 1; margin-left: 10px;">${hostName.includes("workers.dev") ? ty : pty}</div>
                        </div>
                        <button class="copy-btn" style="margin-top: 5px;" onclick="copyToClipboard('${hostName.includes("workers.dev") ? ty : pty}')">复制通用订阅</button>
                    </div>
                    
                    <div style="margin: 15px 0;">
                        <div style="display: flex; margin-bottom: 10px;">
                            <span style="width: 120px; font-weight: bold;">Clash订阅:</span>
                            <div class="link-container" style="flex-grow: 1; margin-left: 10px;">${hostName.includes("workers.dev") ? cl : pcl}</div>
                        </div>
                        <button class="copy-btn" style="margin-top: 5px;" onclick="copyToClipboard('${hostName.includes("workers.dev") ? cl : pcl}')">复制Clash订阅</button>
                    </div>
                    
                    <div style="margin: 15px 0;">
                        <div style="display: flex; margin-bottom: 10px;">
                            <span style="width: 120px; font-weight: bold;">Sing-box订阅:</span>
                            <div class="link-container" style="flex-grow: 1; margin-left: 10px;">${hostName.includes("workers.dev") ? sb : psb}</div>
                        </div>
                        <button class="copy-btn" style="margin-top: 5px;" onclick="copyToClipboard('${hostName.includes("workers.dev") ? sb : psb}')">复制Sing-box订阅</button>
                    </div>
                    
                    ${hostName.includes("workers.dev") ? `
                    <div class="info-section" style="margin-top: 15px;">
                        <strong>注意：</strong> 默认每个订阅链接包含TLS+非TLS共13个端口节点
                    </div>
                    ` : `
                    <div class="info-section" style="margin-top: 15px;">
            ...
            <!-- 通用分享磁贴 -->
            <div class="tile color-gray">
                <div class="tile-content">
                    <div class="tile-title">
                        <i>📋</i>
                        <h2>通用分享</h2>
                    </div>
                    <p>可直接导入支持VLESS的客户端</p>
                    <button class="copy-btn" onclick="copyToClipboard('${hostName.includes("workers.dev") ? wk\u0076\u006c\u0065\u0073\u0073share : pg\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button>
                    <p class="note">分享链接已Base64编码，导入客户端时需先解码</p>
                </div>
            </div>
            
            <!-- 社交媒体磁贴 -->
            <div class="social-tiles grid">
                <div class="tile color-purple">
                    <div class="tile-content">
                        <div class="tile-icon">📺</div>
                        <h2>YouTube</h2>
                        <p>甬哥YouTube频道</p>
                        <a href="https://www.youtube.com/@ygkkk" target="_blank" class="copy-btn" style="background: #ff0000;">访问频道</a>
                    </div>
                </div>
                ...
                <div class="tile color-gray">
                    <div class="tile-content">
                        ...
                        <h2>博客</h2>
                        <p>甬哥博客地址</p>
                        <a href="https://ygkkk.blogspot.com" target="_blank" class="copy-btn">访问博客</a>
                    </div>
                </div>
                ...
                <div class="tile color-primary">
                    <div class="tile-content">
                        ...
                        <h2>TG群组</h2>
                        <p>甬哥TG电报群组</p>
                        <a href="https://t.me/ygkkktg" target="_blank" class="copy-btn" style="background: #229ed9;">加入群组</a>
                    </div>
                </div>
                ...
                <div class="tile color-secondary">
                    <div class="tile-content">
                        ...
                        <h2>TG频道</h2>
                        <p>甬哥TG电报频道</p>
                        <a href="https://t.me/ygkkktgpd" target="_blank" class="copy-btn" style="background: #4caf50;">加入频道</a>
                    </div>
                </div>
            </div>
        </div>
