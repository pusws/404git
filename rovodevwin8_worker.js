...
<title>VLESS 代理配置 - Metro UI</title>
<style>
* {
    margin: 0;
    padding: 0;
...
function toggleConfig(element) {
    const config = element.querySelector('.config-display');
...
<div class="metro-container">
    ...
    <div class="tile header-tile">
        ...
        <div class="tile-title">VLESS 代理配置中心</div>
        <div class="tile-subtitle">Cloudflare Workers V25.5.27</div>
    </div>

    <!-- WS节点磁贴 -->
    <div class="tile tile-wide tile-blue" onclick="toggleConfig(this)">
        <div class="tile-icon">🔓</div>
        <div class="tile-title">WS 节点</div>
        <div class="tile-subtitle">无TLS加密 · 无视域名阻断</div>
        <div class="notification-badge">1</div>
        <div class="config-display" style="display:none;">
            <div style="margin-bottom: 10px;">
                <strong>节点链接：</strong><br>
                <span style="word-break: break-all; font-size: 0.8em;">${w\u0076\u006c\u0065\u0073\u0073ws}</span>
            </div>
            <button onclick="event.stopPropagation(); copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')" 
                    style="background: #0078d4; color: white; border: none; padding: 8px 16px; cursor: pointer;">
                复制链接
            </button>
        </div>
    </div>
    ...
    <!-- WS+TLS节点磁贴 -->
    <div class="tile tile-wide tile-green" onclick="toggleConfig(this)">
        <div class="tile-icon">🔒</div>
        <div class="tile-title">WS+TLS 节点</div>
        <div class="tile-subtitle">TLS加密 · 建议开启分片</div>
        <div class="notification-badge">1</div>
        <div class="config-display" style="display:none;">
            <div style="margin-bottom: 10px;">
                <strong>节点链接：</strong><br>
                <span style="word-break: break-all; font-size: 0.8em;">${p\u0076\u006c\u0065\u0073\u0073wstls}</span>
            </div>
            <button onclick="event.stopPropagation(); copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')" 
                    style="background: #107c10; color: white; border: none; padding: 8px 16px; cursor: pointer;">
                复制链接
            </button>
        </div>
    </div>
    ...
    <!-- 通用订阅磁贴 -->
    <div class="tile tile-small tile-orange" onclick="copyToClipboard('${ty}')">
        <div class="tile-icon">📋</div>
        <div class="tile-title">通用订阅</div>
        <div class="tile-subtitle">Universal</div>
    </div>

    <!-- Clash订阅磁贴 -->
    <div class="tile tile-small tile-purple" onclick="copyToClipboard('${cl}')">
        <div class="tile-icon">⚔️</div>
        <div class="tile-title">Clash Meta</div>
        <div class="tile-subtitle">订阅链接</div>
    </div>

    <!-- Sing-box订阅磁贴 -->
    <div class="tile tile-small tile-red" onclick="copyToClipboard('${sb}')">
        <div class="tile-icon">📦</div>
    ...
    <!-- 分享链接磁贴 -->
    <div class="tile tile-small tile-teal" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">
        <div class="tile-icon">🔗</div>
        <div class="tile-title">分享链接</div>
        <div class="tile-subtitle">直接导入</div>
    </div>

    <!-- 配置信息磁贴 -->
    <div class="tile tile-large tile-pink live-tile" onclick="toggleConfig(this)">
        <div class="tile-icon">⚙️</div>
        <div class="tile-title">配置参数</div>
        <div class="tile-subtitle">客户端设置信息</div>
        <div class="live-content">
            UUID: ${userID.substring(0, 8)}...
        </div>
        <div class="config-display" style="display:none;">
            <div><strong>用户ID：</strong> ${userID}</div>
            <div><strong>伪装域名：</strong> ${hostName}</div>
            <div><strong>路径：</strong> /?ed=2560</div>
            <div><strong>HTTP端口：</strong> 80, 8080, 8880, 2052, 2082, 2086, 2095</div>
            <div><strong>HTTPS端口：</strong> 443, 8443, 2053, 2083, 2087, 2096</div>
            <div><strong>传输协议：</strong> WebSocket</div>
        </div>
    </div>

    <!-- 使用说明磁贴 -->
    <div class="tile tile-wide tile-yellow live-tile" onclick="toggleConfig(this)">
        <div class="tile-icon">💡</div>
        <div class="tile-title">使用说明</div>
        <div class="tile-subtitle">重要提示与注意事项</div>
        <div class="live-content">
            点击查看详细说明
        </div>
        <div class="config-display" style="display:none;">
            <div><strong>注意事项：</strong></div>
            <div>• 默认包含TLS+非TLS共13个端口节点</div>
            <div>• Workers域名需通过代理进行订阅更新</div>
            <div>• 不支持分片功能的客户端无法使用TLS节点</div>
            <div>• ProxyIP使用NAT64自动生成，无需设置</div>
            <br>
            <div><strong>博客频道：</strong></div>
            <div>• 甬哥博客：https://ygkkk.blogspot.com</div>
            <div>• YouTube：https://www.youtube.com/@ygkkk</div>
            <div>• TG群组：https://t.me/ygkkktg</div>
            <div>• TG频道：https://t.me/ygkkktgpd</div>
        </div>
    </div>
</div>
</body>
...
<div class="metro-container">
    ...
    <div class="tile header-tile">
        <div class="tile-icon">🌐</div>
        <div class="tile-title">VLESS 代理配置中心</div>
        <div class="tile-subtitle">Cloudflare Pages/自定义域名 V25.5.27</div>
    </div>

    <!-- WS+TLS节点磁贴 -->
    <div class="tile tile-large tile-blue" onclick="toggleConfig(this)">
        <div class="tile-icon">🔐</div>
        <div class="tile-title">WS+TLS 节点</div>
        <div class="tile-subtitle">TLS加密 · 可选分片功能</div>
        <div class="notification-badge">1</div>
        <div class="live-content">
            安全连接已启用
        </div>
    ...
    <!-- Pages通用订阅磁贴 -->
    <div class="tile tile-small tile-green" onclick="copyToClipboard('${pty}')">
        <div class="tile-icon">📋</div>
        <div class="tile-title">通用订阅</div>
        <div class="tile-subtitle">Pages版</div>
    </div>

    <!-- Pages Clash订阅磁贴 -->
    <div class="tile tile-small tile-purple" onclick="copyToClipboard('${pcl}')">
        <div class="tile-icon">⚔️</div>
        <div class="tile-title">Clash Meta</div>
        <div class="tile-subtitle">Pages版</div>
    </div>
    ...
    <!-- Pages Sing-box订阅磁贴 -->
    <div class="tile tile-small tile-red" onclick="copyToClipboard('${psb}')">
        <div class="tile-icon">📦</div>
        <div class="tile-title">Sing-box</div>
        <div class="tile-subtitle">Pages版</div>
    </div>
    ...
    <!-- Pages分享链接磁贴 -->
    <div class="tile tile-small tile-orange" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">
        <div class="tile-icon">🔗</div>
        <div class="tile-title">分享链接</div>
        <div class="tile-subtitle">直接导入</div>
    </div>
    ...
    <!-- 配置信息磁贴 -->
    <div class="tile tile-wide tile-teal live-tile" onclick="toggleConfig(this)">
        <div class="tile-icon">⚙️</div>
        <div class="tile-title">配置参数</div>
        <div class="tile-subtitle">客户端设置信息</div>
        <div class="live-content">
        ...
        <div class="config-display" style="display:none;">
            ...
            <div><strong>HTTPS端口：</strong> 443, 8443, 2053, 2083, 2087, 2096</div>
            <div><strong>传输协议：</strong> WebSocket</div>
            <div><strong>传输安全：</strong> TLS开启</div>
            <div><strong>证书验证：</strong> 不跳过</div>
        </div>
    </div>

    <!-- 使用说明磁贴 -->
    <div class="tile tile-wide tile-pink live-tile" onclick="toggleConfig(this)">
        <div class="tile-icon">💡</div>
        <div class="tile-title">使用说明</div>
        <div class="tile-subtitle">重要提示与注意事项</div>
        <div class="live-content">
        ...
        <div class="config-display" style="display:none;">
            <div><strong>注意事项：</strong></div>
            <div>• 以下订阅链接仅包含6个TLS端口节点</div>
            <div>• 支持客户端分片(Fragment)功能</div>
            <div>• 可开启分片功能防止域名阻断</div>
            <div>• ProxyIP使用NAT64自动生成，无需设置</div>
            <br>
            <div><strong>博客频道：</strong></div>
            <div>• 甬哥博客：https://ygkkk.blogspot.com</div>
