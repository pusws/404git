...
.ukraine-container {
  ...
  border-radius: 20px;
  box-shadow: 0 20px 40px rgba(0, 91, 187, 0.3);
  margin: 20px 0;
  padding: 30px;
...
.ukraine-table {
  ...
  border-radius: 15px;
  overflow: hidden;
  box-shadow: 0 10px 20px rgba(0, 91, 187, 0.1);
}
...
.ukraine-table tbody tr {
  border-bottom: 1px solid rgba(255, 215, 0, 0.3);
}

.ukraine-table tbody tr:hover {
...
@keyframes ukraineGlow {
  0% { box-shadow: 0 0 5px var(--ukraine-yellow); }
  50% { box-shadow: 0 0 20px var(--ukraine-yellow), 0 0 30px var(--ukraine-blue); }
  100% { box-shadow: 0 0 5px var(--ukraine-yellow); }
}

.ukraine-glow {
  animation: ukraineGlow 2s ease-in-out infinite;
}
...
.ukraine-support-statement p {
  margin: 0;
  text-align: center;
}

.ukraine-support-statement .ukraine-icon {
  color: #e74c3c;
  margin-right: 8px;
}
</style>
...
function copyToClipboard(text) {
  ...
  toast.className = 'toast-ukraine';
  toast.style.cssText = 'position: fixed; top: 20px; right: 20px; padding: 15px 25px; border-radius: 15px; z-index: 9999; font-weight: bold;';
  toast.innerHTML = '<i class="fas fa-check-circle"></i> 已复制到剪贴板';
...
${displayHtml}
<body>
<div class="ukraine-container container">
    <div class="ukraine-hero">
        <div class="ukraine-flag"></div>
        <h1 class="ukraine-header"><i class="fas fa-shield-alt ukraine-icon"></i>Cloudflare Workers VLESS 代理服务</h1>
        <div class="ukraine-badge">V25.5.4</div>
        <div class="ukraine-support-statement">
            <p><i class="fas fa-heart ukraine-icon"></i><strong>支持乌克兰 谴责俄罗斯侵略和战争罪行</strong></p>
        </div>
    </div>
    
    <div class="ukraine-info-card">
        <h5><i class="fas fa-info-circle ukraine-icon"></i>服务信息</h5>
        <p class="mb-0">${noteshow}</p>
    </div>
    
    <hr class="ukraine-divider">
    
    <div class="ukraine-card">
        <div class="ukraine-card-header">
            <i class="fas fa-globe ukraine-icon"></i>CF-Workers VLESS+WS 节点
        </div>
        <div class="card-body">
            <table class="table ukraine-table">
                <thead>
                    <tr>
                        <th><i class="fas fa-star"></i> 节点特色</th>
                        <th><i class="fas fa-link"></i> 单节点链接</th>
                        <th><i class="fas fa-copy"></i> 操作</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="limited-width">
                            <span class="ukraine-badge">无TLS加密</span><br>
                            无视域名阻断
                        </td>
                        <td class="limited-width">${w\u0076\u006c\u0065\u0073\u0073ws}</td>
                        <td><button class="ukraine-btn ukraine-glow" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            
            <div class="ukraine-params">
                <h5><i class="fas fa-cog ukraine-icon"></i>客户端参数</h5>
                <ul>
                    <li><strong>客户端地址:</strong> 自定义域名 或 优选域名 或 优选IP 或 反代IP</li>
                    <li><strong>端口:</strong> 7个HTTP端口(80、8080、8880、2052、2082、2086、2095)</li>
                    <li><strong>用户ID:</strong> <code>${userID}</code></li>
                    <li><strong>传输协议:</strong> ws 或 websocket</li>
                    <li><strong>伪装域名:</strong> <code>${hostName}</code></li>
                    <li><strong>路径:</strong> <code>/?ed=2560</code></li>
    ...
    <div class="ukraine-card">
        <div class="ukraine-card-header">
            <i class="fas fa-lock ukraine-icon"></i>CF-Workers VLESS+WS+TLS 节点
        </div>
        <div class="card-body">
            <table class="table ukraine-table">
                <thead>
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">
                            <span class="ukraine-badge">TLS加密</span><br>
                            建议开启分片功能防止域名阻断
                        </td>
                        <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                        <td><button class="ukraine-btn ukraine-glow" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="ukraine-params">
                ...
                <ul>
                    <li><strong>客户端地址:</strong> 自定义域名 或 优选域名 或 优选IP 或 反代IP</li>
                    <li><strong>端口:</strong> 6个HTTPS端口(443、8443、2053、2083、2087、2096)</li>
                    <li><strong>用户ID:</strong> <code>${userID}</code></li>
                    <li><strong>传输协议:</strong> ws 或 websocket</li>
                    <li><strong>伪装域名:</strong> <code>${hostName}</code></li>
                    <li><strong>路径:</strong> <code>/?ed=2560</code></li>
    ...
    <div class="ukraine-card">
        <div class="ukraine-card-header">
            <i class="fas fa-rss ukraine-icon"></i>聚合通用、Clash-meta、Sing-box订阅链接
        </div>
        <div class="card-body">
            <div class="ukraine-info-card">
                ...
                3、如使用的客户端不支持分片功能，则TLS节点不可用</p>
            </div>
            
            <table class="table ukraine-table">
                <thead>
                    <tr>
                        <th><i class="fas fa-share-alt"></i> 聚合通用分享链接 (可直接导入客户端)</th>
                        <th><i class="fas fa-copy"></i> 操作</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><span class="ukraine-badge">通用分享</span></td>
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                <thead>
                    <tr>
                        <th><i class="fas fa-rss"></i> 聚合通用订阅链接</th>
                        <th><i class="fas fa-copy"></i> 操作</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${ty}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                <thead>
                    <tr>
                        <th><i class="fab fa-github"></i> Clash-meta订阅链接</th>
                        <th><i class="fas fa-copy"></i> 操作</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${cl}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                <thead>
                    <tr>
                        <th><i class="fas fa-cube"></i> Sing-box订阅链接</th>
                        <th><i class="fas fa-copy"></i> 操作</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${sb}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="ukraine-container container">
    <div class="ukraine-hero">
        <div class="ukraine-flag"></div>
        <h1 class="ukraine-header"><i class="fas fa-shield-alt ukraine-icon"></i>Cloudflare Pages/Workers VLESS 代理服务</h1>
        <div class="ukraine-badge">V25.5.4</div>
        <div class="ukraine-support-statement">
            <p><i class="fas fa-heart ukraine-icon"></i><strong>支持乌克兰 谴责俄罗斯侵略和战争罪行</strong></p>
        </div>
    ...
    <div class="ukraine-card">
        <div class="ukraine-card-header">
            <i class="fas fa-lock ukraine-icon"></i>CF-Pages/Workers/自定义域 VLESS+WS+TLS 节点
        </div>
        <div class="card-body">
            <table class="table ukraine-table">
                <thead>
    ...
    <div class="ukraine-card">
        ...
        <div class="card-body">
            <div class="ukraine-info-card">
                <p><strong>注意：</strong>以下订阅链接仅6个TLS端口节点</p>
            </div>
            ...
            <table class="table ukraine-table">
                ...
                <tbody>
                    <tr>
                        <td><span class="ukraine-badge">通用分享</span></td>
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${pty}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${pcl}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table ukraine-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${psb}')"><i class="fas fa-copy"></i> 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
