...
function createWebSocketReadableStream(ws， earlyDataHeader) {
  return new ReadableStream({
    start(controller) {
      ...
      if (earlyDataHeader) {
        try {
          const decoded = atob(earlyDataHeader。替换(/-/g， '+').replace(/_/g, '/'));
...
function get\u0076\u006c\u0065\u0073\u0073Config(userID, hostName) {
	...
	const workersDevContent = `
		<div class="tile-group">
			<div class="tile-container">
				<div class="tile tile-blue" onclick="copyToClipboard('${wvlessws}')">
					<div class="tile-icon">📡</div>
					<div class="tile-title">VLESS+WS</div>
					<div class="tile-desc">非TLS节点，点击复制</div>
				</div>
				<div class="tile tile-green" onclick="copyToClipboard('${pvlesswstls}')">
					<div class="tile-icon">🛰️</div>
					<div class="tile-title">VLESS+WS+TLS</div>
					<div class="tile-desc">TLS节点，点击复制</div>
				</div>
			</div>
		</div>
		<h2 class="group-title">通用订阅 (TLS + 非TLS)</h2>
		<div class="tile-group">
			<div class="tile-container">
				<div class="tile tile-orange" onclick="copyToClipboard('${ty}')">
					<div class="tile-icon">📋</div>
					<div class="tile-title">通用订阅</div>
					<div class="tile-desc">Base64，点击复制</div>
				</div>
				<div class="tile tile-red" onclick="copyToClipboard('${cl}')">
					<div class="tile-icon">Clash</div>
					<div class="tile-title">Clash.Meta</div>
					<div class="tile-desc">订阅链接，点击复制</div>
				</div>
				<div class="tile tile-purple" onclick="copyToClipboard('${sb}')">
					<div class="tile-icon">sBox</div>
	...
	const pagesContent = `
		...
		<h2 class="group-title">通用订阅 (仅TLS)</h2>
		<div class="tile-group">
			<div class="tile-container">
				<div class="tile tile-orange" onclick="copyToClipboard('${pty}')">
					<div class="tile-icon">📋</div>
					<div class="tile-title">通用订阅</div>
					<div class="tile-desc">Base64，点击复制</div>
				</div>
				<div class="tile tile-red" onclick="copyToClipboard('${pcl}')">
					<div class="tile-icon">Clash</div>
					<div class="tile-title">Clash.Meta</div>
					<div class="tile-desc">订阅链接，点击复制</div>
				</div>
				<div class="tile tile-purple" onclick="copyToClipboard('${psb}')">
					<div class="tile-icon">sBox</div>
					<div class="tile-title">Sing-Box</div>
					<div class="tile-desc">订阅链接，点击复制</div>
				</div>
	...
	<head>
		...
		<style>
			...
			.tile-orange { background-color: #F09609; }
			.tile-red { background-color: #E51400; }
			.tile-purple { background-color: #6400AA; }
			...
			.info-tile p { margin: 5px 0; }
			.info-tile a { color: #fff; text-decoration: underline; }
	...
	<body>
		<div class="container">
			...
			<h2 class="group-title">节点配置</h2>
			${isWorkersDev ? workersDevContent : pagesContent}

			<h2 class="group-title">信息</h2>
			<div class="tile-group">
				<div class="tile-container">
					<div class="tile tile-teal info-tile">
						<div class="tile-content">
							<p><strong>注意:</strong> ProxyIP使用nat64自动生成，无需设置。</p>
							<p><a href="https://ygkkk.blogspot.com" target="_blank">博客</a> | <a href="https://www.youtube.com/@ygkkk" target="_blank">YouTube</a> | <a href="https://t.me/ygkkktg" target="_blank">Telegram群组</a> | <a href="https://t.me/ygkkktgpd" target="_blank">Telegram频道</a></p>
						</div>
					</div>
				</div>
			</div>
