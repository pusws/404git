...
async function checkUuidInApiResponse(targetUuid) {
  ...
  try {
    ...
    const isUuidInResponse = apiResponse。用户.some((user) => user.uuid === targetUuid);
...
:root {
  ...
  --ukraine-blue-dark: #004080;
  --ukraine-yellow-light: #FFE55C;
}

body {
  background: linear-gradient(180deg, var(--ukraine-blue) 50%, var(--ukraine-yellow) 50%);
...
.btn-primary:hover {
  ...
  border-color: var(--ukraine-blue-dark);
}
...
hr {
  border-top: 2px solid var(--ukraine-yellow);
}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-info text-center" role="alert">
                <h2>支持乌克兰</h2>
                <p>我们支持乌克兰的主权和领土完整。我们谴责俄罗斯的入侵行为及其所犯下的战争罪行。</p>
                <p>We stand with Ukraine. We condemn Russia's invasion and war crimes.</p>
            </div>
