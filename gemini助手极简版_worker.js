...
${displayHtml}
          <div class="card">
            <div class="card-header">
              CF-workers-vless+ws节点
            </div>
            <div class="card-body">
              <h5 class="card-title">节点特色</h5>
              <p class="card-text">关闭了TLS加密，无视域名阻断</p>
              <h5 class="card-title mt-4">单节点链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${w\u0076\u006c\u0065\u0073\u0073ws}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制</button>
              </div>
              <h5 class="card-title mt-4">客户端参数</h5>
              <ul>
          ...
          <div class="card">
            <div class="card-header">
              CF-workers-vless+ws+tls节点
            </div>
            <div class="card-body">
              <h5 class="card-title">节点特色</h5>
              <p class="card-text">启用了TLS加密，<br>如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</p>
              <h5 class="card-title mt-4">单节点链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${p\u0076\u006c\u0065\u0073\u0073wstls}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制</button>
              </div>
              <h5 class="card-title mt-4">客户端参数</h5>
              <ul>
                <li>客户端地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
          ...
          <div class="card">
            <div class="card-header">
              聚合通用、Clash-meta、Sing-box订阅链接
            </div>
            <div class="card-body">
              <p>注意：<br>1、默认每个订阅链接包含TLS+非TLS共13个端口节点<br>2、当前workers域名作为订阅链接，需通过代理进行订阅更新<br>3、如使用的客户端不支持分片功能，则TLS节点不可用</p>
              <h5 class="card-title mt-4">聚合通用分享链接 (可直接导入客户端)</h5>
              <div class="input-group mb-3">
                <button class="btn btn-primary copy-btn" type="button" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">点击复制链接</button>
              </div>
              <h5 class="card-title mt-4">聚合通用订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${ty}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${ty}')">复制</button>
              </div>
              <h5 class="card-title mt-4">Clash-meta订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${cl}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${cl}')">复制</button>
              </div>
              <h5 class="card-title mt-4">Sing-box订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${sb}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${sb}')">复制</button>
              </div>
            </div>
          </div>
        </div>
...
${displayHtml}
          <div class="card">
            <div class="card-header">
              CF-pages/workers/自定义域-vless+ws+tls节点
            </div>
            <div class="card-body">
              <h5 class="card-title">节点特色</h5>
              <p class="card-text">启用了TLS加密，<br>如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</p>
              <h5 class="card-title mt-4">单节点链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${p\u0076\u006c\u0065\u0073\u0073wstls}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制</button>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title mt-4">聚合通用分享链接 (可直接导入客户端)</h5>
              <div class="input-group mb-3">
                <button class="btn btn-primary copy-btn" type="button" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">点击复制链接</button>
              </div>
              <h5 class="card-title mt-4">聚合通用订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${pty}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${pty}')">复制</button>
              </div>
              <h5 class="card-title mt-4">Clash-meta订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${pcl}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${pcl}')">复制</button>
              </div>
              <h5 class="card-title mt-4">Sing-box订阅链接</h5>
              <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${psb}" readonly>
                <button class="btn btn-outline-secondary copy-btn" type="button" onclick="copyToClipboard('${psb}')">复制</button>
              </div>
            </div>
          </div>
        </div>
