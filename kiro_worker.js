	...
	<body>
		...
		<div class="container">
			...
			<div class="status-bar">
				...
				<div class="status-text">系统运行正常 - 所有节点可用</div>
			</div>
            ...
            hostName.includes("workers.dev")
              ...
              : ""
                ...
                hostName.includes("workers.dev") ? ty : pty
              }" readonly>
							<button class="btn" onclick="App.copyToClipboard('${
                hostName.includes("workers.dev") ? ty : pty
              }')">复制</button>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="input-group">
							<input type="text" class="form-control" value="${
                hostName.includes("workers.dev") ? cl : pcl
              }" readonly>
							<button class="btn" onclick="App.copyToClipboard('${
                hostName.includes("workers.dev") ? cl : pcl
              }')">复制</button>
					...
					<div class="card">
						...
						<div class="input-group">
							<input type="text" class="form-control" value="${
                hostName.includes("workers.dev") ? sb : psb
              }" readonly>
							<button class="btn" onclick="App.copyToClipboard('${
                hostName.includes("workers.dev") ? sb : psb
              }')">复制</button>
					...
					<div class="card">
						...
						<div class="card-actions">
							<button class="btn btn-full" onclick="App.copyToClipboard('${
                hostName.includes("workers.dev") ? wkShare : pgShare
              }')">复制聚合链接</button>
							<button class="btn btn-secondary btn-full" onclick="App.showQrCode('${
                hostName.includes("workers.dev") ? wkShare : pgShare
              }', '聚合分享链接')">显示二维码</button>
						</div>
					</div>
