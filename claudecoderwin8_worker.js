...
.tile-blue { background: #2d89ef; }
.tile-green { background: #00a300; }
.tile-orange { background: #ff6a00; }
.tile-purple { background: #9f00a7; }
.tile-red { background: #e74c3c; }
.tile-teal { background: #00aba9; }
.tile-yellow { background: #ffc40d; }
.tile-dark { background: #2b2b2b; }
.tile-header {
  display: flex;
  align-items: center;
  margin-bottom: 20px;
...
@media (max-width: 768px) {
  .metro-title { font-size: 2.5rem; }
  .metro-subtitle { font-size: 1.2rem; }
  .metro-grid { grid-template-columns: 1fr; }
  .metro-tile-large { grid-column: span 1; }
  .metro-container { padding: 20px 15px; }
}
</style>
</head>
<script>
...
function showNotification(message, type = 'info') {
  ...
  notification.style.cssText = \`
    ...
    background: \${type === 'success' ? '#00a300' : '#2d89ef'};
    color: white; padding: 15px 25px; border-radius: 0;
...
<div class="metro-container">
    <div class="metro-header">
        <h1 class="metro-title">Cloudflare Workers</h1>
        <h2 class="metro-subtitle">VLESS 代理脚本 V25.5.27</h2>
    </div>
    
    <div class="metro-note">
        <p>${noteshow}</p>
    </div>

    <div class="metro-grid">
        <!-- WS 节点磁贴 -->
        <div class="metro-tile metro-tile-large tile-blue live-tile">
            ...
            <div class="tile-subtitle">关闭TLS加密，无视域名阻断</div>
            <div class="tile-content">
                <div class="tile-link">${w\u0076\u006c\u0065\u0073\u0073ws}</div>
                <button class="tile-button" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制节点链接</button>
        ...
        <!-- TLS 节点磁贴 -->
        <div class="metro-tile metro-tile-large tile-green live-tile">
            <div class="tile-header">
                <svg class="tile-icon" viewBox="0 0 24 24">
                ...
                <div class="tile-title">TLS 节点</div>
            </div>
            <div class="tile-subtitle">启用TLS加密，支持分片功能</div>
            <div class="tile-content">
                <div class="tile-link">${p\u0076\u006c\u0065\u0073\u0073wstls}</div>
                <button class="tile-button" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制节点链接</button>
                <div class="tile-params">
                    <ul>
                        <li>端口: 443, 8443, 2053, 2083, 2087, 2096</li>
                        <li>UUID: ${userID}</li>
                        <li>传输: WebSocket + TLS</li>
                        <li>域名: ${hostName}</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="metro-tile tile-orange">
            ...
            <div class="tile-subtitle">包含13个端口节点</div>
            <div class="tile-content">
                <button class="tile-button" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button>
                <button class="tile-button" onclick="copyToClipboard('${ty}')">复制订阅链接</button>
            </div>
        </div>
        ...
        <div class="metro-tile tile-purple">
            ...
            <div class="tile-subtitle">适用于 Clash Meta 客户端</div>
            <div class="tile-content">
                <div class="tile-link">${cl}</div>
                <button class="tile-button" onclick="copyToClipboard('${cl}')">复制订阅链接</button>
            </div>
        </div>
        ...
        <div class="metro-tile tile-teal">
            ...
            <div class="tile-subtitle">适用于 Sing-box 客户端</div>
            <div class="tile-content">
                <div class="tile-link">${sb}</div>
                <button class="tile-button" onclick="copyToClipboard('${sb}')">复制订阅链接</button>
            </div>
        </div>

        <!-- 使用说明磁贴 -->
        <div class="metro-tile metro-tile-wide tile-dark">
            <div class="tile-header">
                <svg class="tile-icon" viewBox="0 0 24 24">
...
<div class="metro-container">
    <div class="metro-header">
        <h1 class="metro-title">Cloudflare Pages</h1>
        <h2 class="metro-subtitle">VLESS 代理脚本 V25.5.27</h2>
    </div>
    ...
    <div class="metro-grid">
        ...
        <div class="metro-tile tile-orange">
            ...
            <div class="tile-subtitle">仅包含6个TLS端口节点</div>
            <div class="tile-content">
                <button class="tile-button" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button>
                <button class="tile-button" onclick="copyToClipboard('${pty}')">复制订阅链接</button>
            </div>
        </div>
        ...
        <div class="metro-tile tile-purple">
            ...
            <div class="tile-subtitle">适用于 Clash Meta 客户端</div>
            <div class="tile-content">
                <div class="tile-link">${pcl}</div>
                <button class="tile-button" onclick="copyToClipboard('${pcl}')">复制订阅链接</button>
            </div>
        </div>
        ...
        <div class="metro-tile tile-teal">
            ...
            <div class="tile-subtitle">适用于 Sing-box 客户端</div>
            <div class="tile-content">
                <div class="tile-link">${psb}</div>
                <button class="tile-button" onclick="copyToClipboard('${psb}')">复制订阅链接</button>
            </div>
        </div>

        <!-- Pages特性磁贴 -->
        <div class="metro-tile metro-tile-wide tile-blue">
            <div class="tile-header">
                <svg class="tile-icon" viewBox="0 0 24 24">
                    <path d="M12,2A2,2 0 0,1 14,4C14,4.74 13.6,5.39 13,5.73V7H14A7,7 0 0,1 21,14H22A1,1 0 0,1 23,15V18A1,1 0 0,1 22,19H21V20A2,2 0 0,1 19,22H5A2,2 0 0,1 3,20V19H2A1,1 0 0,1 1,18V15A1,1 0 0,1 2,14H3A7,7 0 0,1 10,7H11V5.73C10.4,5.39 10,4.74 10,4A2,2 0 0,1 12,2M7.5,13A2.5,2.5 0 0,0 5,15.5A2.5,2.5 0 0,0 7.5,18A2.5,2.5 0 0,0 10,15.5A2.5,2.5 0 0,0 7.5,13M16.5,13A2.5,2.5 0 0,0 14,15.5A2.5,2.5 0 0,0 16.5,18A2.5,2.5 0 0,0 19,15.5A2.5,2.5 0 0,0 16.5,13Z"/>
                </svg>
                <div class="tile-title">Pages 特性</div>
            </div>
            <div class="tile-content">
                <div style="font-size: 0.9rem; line-height: 1.5;">
                    <p>• 自定义域名支持</p>
