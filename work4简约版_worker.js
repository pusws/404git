...
<div class="container my-5">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title text-center">Cloudflare-workers/pages-vless代理脚本 V25.5.27</h1>
            <hr>
            <p class="text-muted">${noteshow}</p>
            <hr>
        </div>
    </div>
    <div class="card">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制</button></td>
                    </tr>
                </tbody>
            </table>
            <h5 class="mt-4">客户端参数</h5>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">地址：自定义的域名 / 优选域名 / 优选IP / 反代IP</li>
                <li class="list-group-item">端口：80、8080、8880、2052、2082、2086、2095</li>
                <li class="list-group-item">UUID：${userID}</li>
                <li class="list-group-item">传输协议：ws</li>
                <li class="list-group-item">伪装域名：${hostName}</li>
                <li class="list-group-item">路径：/?ed=2560</li>
                <li class="list-group-item">TLS：关闭</li>
            </ul>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">启用了TLS加密，如果客户端支持分片功能，建议开启，防止域名阻断</td>
                        <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制</button></td>
                    </tr>
                </tbody>
            </table>
            <h5 class="mt-4">客户端参数</h5>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">地址：自定义的域名 / 优选域名 / 优选IP / 反代IP</li>
                <li class="list-group-item">端口：443、8443、2053、2083、2087、2096</li>
                <li class="list-group-item">UUID：${userID}</li>
                <li class="list-group-item">传输协议：ws</li>
                <li class="list-group-item">伪装域名：${hostName}</li>
                <li class="list-group-item">路径：/?ed=2560</li>
                <li class="list-group-item">TLS：开启</li>
                <li class="list-group-item">allowInsecure：false</li>
            </ul>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <p class="alert alert-info">注意：默认包含13个端口节点；需通过代理更新；TLS节点需分片支持</p>
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th>类型</th>
                ...
                <tbody>
                    <tr>
                        <td>通用分享</td>
                        <td><button class="btn btn-link p-0" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>通用订阅</td>
                        <td class="limited-width">${ty}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${ty}')">复制</button></td>
                    </tr>
                    <tr>
                        <td>Clash-meta</td>
                        <td class="limited-width">${cl}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${cl}')">复制</button></td>
                    </tr>
                    <tr>
                        <td>Sing-box</td>
                        <td class="limited-width">${sb}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${sb}')">复制</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="container my-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">启用了TLS加密，如果客户端支持分片功能，可开启，防止域名阻断</td>
                        <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制</button></td>
                    </tr>
                </tbody>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <p class="alert alert-info">注意：仅包含6个TLS端口节点</p>
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th>类型</th>
                ...
                <tbody>
                    <tr>
                        <td>通用分享</td>
                        <td><button class="btn btn-link p-0" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制分享链接</button></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>通用订阅</td>
                        <td class="limited-width">${pty}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${pty}')">复制</button></td>
                    </tr>
                    <tr>
                        <td>Clash-meta</td>
                        <td class="limited-width">${pcl}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${pcl}')">复制</button></td>
                    </tr>
                    <tr>
                        <td>Sing-box</td>
                        <td class="limited-width">${psb}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="copyToClipboard('${psb}')">复制</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
