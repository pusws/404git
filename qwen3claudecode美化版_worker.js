...
:root {
    ...
    --shadow-md: 0 8px 35px rgba(0, 0, 0, 0.12);
...
@media (max-width: 768px) {
    ...
    .card-header { padding: 2rem 1rem 1rem; }
    .card-header h2 { font-size: 1.5rem; }
    .card-body { padding: 0 1rem 1rem; }
    .modern-tabs { flex-direction: column; }
    .modern-tabs .nav-link { min-width: auto; }
    .param-grid { grid-template-columns: 1fr; }
    .subscription-grid { grid-template-columns: 1fr; }
    .copy-btn { position: static; transform: none; margin-top: 0.5rem; width: 100%; }
    .modern-input-group .form-control { padding-right: 1.25rem; }
    .toast-container { right: 1rem; top: 1rem; }
}
</style>
</head>
<script>
...
async function copyToClipboard(text, buttonElement) {
    try {
        ...
        if (buttonElement) {
            ...
            buttonElement.innerHTML = '<i class="fas fa-check me-1"></i>已复制';
        ...
        <div class="col-lg-12">
            <div class="glass-card fade-in">
                <div class="card-header">
                    <h2><i class="fas fa-cloud me-3"></i>Cloudflare Workers VLESS 代理脚本</h2>
                    <span class="version-badge">V25.5.27</span>
                </div>
                <div class="card-body">
            ...
            <!-- 现代化导航标签 -->
            <ul class="modern-tabs nav nav-tabs justify-content-center" id="configTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="ws-tab" data-bs-toggle="tab" data-bs-target="#ws" type="button" role="tab">
                        <i class="fas fa-network-wired"></i>WS 节点
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="wstls-tab" data-bs-toggle="tab" data-bs-target="#wstls" type="button" role="tab">
                        <i class="fas fa-lock"></i>WS+TLS 节点
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="configTabsContent">
                    ...
                    <div class="glass-card">
                        ...
                        <div class="card-body">
                            <div class="feature-highlight">
                                <i class="fas fa-shield-alt"></i><strong>节点特色:</strong> 关闭了TLS加密，无视域名阻断
                            </div>
                            
                            <div class="modern-input-group">
                                <label class="form-label"><i class="fas fa-link me-2"></i>节点链接:</label>
                                <textarea class="form-control" readonly>${vlessws}</textarea>
                                <button class="copy-btn" onclick="copyToClipboard('${vlessws}', this)">
                            ...
                            <div class="param-grid">
                                <div class="param-item">
                                    <i class="fas fa-server"></i><strong>地址:</strong> 自定义的域名 或 优选域名 或 优选IP 或 反代IP
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-plug"></i><strong>端口:</strong>
                                    <div class="port-badges">
                                        <span class="port-badge">80</span>
                                        <span class="port-badge">8080</span>
                                        <span class="port-badge">8880</span>
                                        <span class="port-badge">2052</span>
                                        <span class="port-badge">2082</span>
                                        <span class="port-badge">2086</span>
                                        <span class="port-badge">2095</span>
                                    </div>
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-user"></i><strong>用户ID:</strong> ${userID}
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-exchange-alt"></i><strong>传输协议:</strong> ws 或 websocket
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-signature"></i><strong>伪装域名:</strong> ${hostName}
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-route"></i><strong>路径:</strong> /?ed=2560
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-lock-open"></i><strong>传输安全:</strong> 关闭
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="wstls" role="tabpanel" aria-labelledby="wstls-tab">
                    <div class="glass-card">
                        ...
                        <div class="card-body">
                            <div class="feature-highlight">
                                <i class="fas fa-shield-alt"></i><strong>节点特色:</strong> 启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断
                            </div>
                            
                            <div class="modern-input-group">
                                <label class="form-label"><i class="fas fa-link me-2"></i>节点链接:</label>
                                <textarea class="form-control" readonly>${vlesswstls}</textarea>
                                <button class="copy-btn" onclick="copyToClipboard('${vlesswstls}', this)">
                                    <i class="fas fa-copy"></i>复制
                                </button>
                            </div>
                            ...
                            <div class="param-grid">
                                ...
                                <div class="param-item">
                                    <i class="fas fa-plug"></i><strong>端口:</strong>
                                    <div class="port-badges">
                                        <span class="port-badge">443</span>
                                        <span class="port-badge">8443</span>
                                        <span class="port-badge">2053</span>
                                        <span class="port-badge">2083</span>
                                        <span class="port-badge">2087</span>
                                        <span class="port-badge">2096</span>
                                    </div>
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-user"></i><strong>用户ID:</strong> ${userID}
                                ...
                                <div class="param-item">
                                    <i class="fas fa-lock"></i><strong>传输安全:</strong> 开启
                                </div>
                                <div class="param-item">
                                    <i class="fas fa-certificate"></i><strong>跳过证书验证:</strong> false
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="subscription" role="tabpanel" aria-labelledby="subscription-tab">
                    <div class="glass-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <button class="btn-modern w-100" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}', this)">
                            ...
                            <div class="subscription-grid">
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${ty}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${cl}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${sb}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="footer">
                <p class="mb-0"><i class="fas fa-heart me-2"></i>© 2025 Cloudflare Workers VLESS 代理脚本 - 安全高效的网络代理解决方案</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="glass-card fade-in">
                <div class="card-header">
                    <h2><i class="fas fa-cloud me-3"></i>Cloudflare Pages/自定义域 VLESS 代理脚本</h2>
                    <span class="version-badge">V25.5.27</span>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
            ...
            <ul class="modern-tabs nav nav-tabs justify-content-center" id="configTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="wstls-tab" data-bs-toggle="tab" data-bs-target="#wstls" type="button" role="tab">
                        <i class="fas fa-lock"></i>WS+TLS 节点
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="configTabsContent">
                ...
                <div class="tab-pane fade show active" id="wstls" role="tabpanel" aria-labelledby="wstls-tab">
                    <div class="glass-card">
                        ...
                        <div class="card-body">
                            <div class="feature-highlight">
                                <i class="fas fa-shield-alt"></i><strong>节点特色:</strong> 启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启，防止域名阻断
                            </div>
                ...
                <div class="tab-pane fade" id="subscription" role="tabpanel" aria-labelledby="subscription-tab">
                    <div class="glass-card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="section-title">通用分享链接</h5>
                            <div class="mb-4">
                                <button class="btn-modern w-100" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}', this)">
                                    <i class="fas fa-copy me-2"></i>复制通用分享链接 (可直接导入客户端)
                                </button>
                            </div>
                            ...
                            <div class="subscription-grid">
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${pty}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${pcl}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
                                <div class="subscription-card">
                                    ...
                                    <div class="modern-input-group">
                                        ...
                                        <button class="copy-btn" onclick="copyToClipboard('${psb}', this)">
                                            <i class="fas fa-copy"></i>复制
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="footer">
                <p class="mb-0"><i class="fas fa-heart me-2"></i>© 2025 Cloudflare Pages/自定义域 VLESS 代理脚本 - 安全高效的网络代理解决方案</p>
            </div>
        </div>
    </div>
</div>
