...
.btn-copy:hover {
  background: linear-gradient(135deg, #3a86d6 0%, var(--success-color) 100%);
  transform: translateY(-2px);
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
}
...
function copyToClipboard(text) {
  ...
  alertBox.innerHTML = '<i class="fas fa-check-circle icon-spacing"></i> 已复制到剪贴板';
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="header text-center mb-4">
                <h1 class="display-4 fw-bold">Cloudflare-workers/pages-\u0076\u006c\u0065\u0073\u0073代理脚本</h1>
                <p class="lead">V25.5.27</p>
            </div>
            <div class="note mb-4">
                <h5 class="section-title"><i class="fas fa-info-circle icon-spacing"></i>重要信息</h5>
                <p>${noteshow}</p>
            </div>
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="fas fa-server icon-spacing"></i>1：CF-workers-\u0076\u006c\u0065\u0073\u0073+ws节点</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-copy" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <h5 class="section-title"><i class="fas fa-cog icon-spacing"></i>客户端参数如下：</h5>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><i class="fas fa-map-marker-alt icon-spacing"></i>客户端地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
                        <li class="list-group-item"><i class="fas fa-plug icon-spacing"></i>端口(port)：7个http端口可任意选择(80、8080、8880、2052、2082、2086、2095)，或反代IP对应端口</li>
                        <li class="list-group-item"><i class="fas fa-user icon-spacing"></i>用户ID(uuid)：${userID}</li>
                        <li class="list-group-item"><i class="fas fa-exchange-alt icon-spacing"></i>传输协议(network)：ws 或者 websocket</li>
                        <li class="list-group-item"><i class="fas fa-mask icon-spacing"></i>伪装域名(host)：${hostName}</li>
                        <li class="list-group-item"><i class="fas fa-route icon-spacing"></i>路径(path)：/?ed=2560</li>
                        <li class="list-group-item"><i class="fas fa-shield-alt icon-spacing"></i>传输安全(TLS)：关闭</li>
                    </ul>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="fas fa-server icon-spacing"></i>2：CF-workers-\u0076\u006c\u0065\u0073\u0073+ws+tls节点</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-copy" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><i class="fas fa-map-marker-alt icon-spacing"></i>客户端地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
                        <li class="list-group-item"><i class="fas fa-plug icon-spacing"></i>端口(port)：6个https端口可任意选择(443、8443、2053、2083、2087、2096)，或反代IP对应端口</li>
                        <li class="list-group-item"><i class="fas fa-user icon-spacing"></i>用户ID(uuid)：${userID}</li>
                        <li class="list-group-item"><i class="fas fa-exchange-alt icon-spacing"></i>传输协议(network)：ws 或者 websocket</li>
                        <li class="list-group-item"><i class="fas fa-mask icon-spacing"></i>伪装域名(host)：${hostName}</li>
                        <li class="list-group-item"><i class="fas fa-route icon-spacing"></i>路径(path)：/?ed=2560</li>
                        <li class="list-group-item"><i class="fas fa-shield-alt icon-spacing"></i>传输安全(TLS)：开启</li>
                        <li class="list-group-item"><i class="fas fa-certificate icon-spacing"></i>跳过证书验证(allowlnsecure)：false</li>
                    </ul>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="fas fa-link icon-spacing"></i>3：聚合通用、Clash-meta、Sing-box订阅链接如下：</h3>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning" role="alert">
                        <h5 class="alert-heading"><i class="fas fa-exclamation-triangle icon-spacing"></i>注意：</h5>
                        <p>1、默认每个订阅链接包含TLS+非TLS共13个端口节点<br>2、当前workers域名作为订阅链接，需通过代理进行订阅更新<br>3、如使用的客户端不支持分片功能，则TLS节点不可用</p>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead class="table-light">
                            ...
                            <tbody>
                                <tr>
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${ty}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${cl}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${sb}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="fas fa-server icon-spacing"></i>1：CF-pages/workers/自定义域-\u0076\u006c\u0065\u0073\u0073+ws+tls节点</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="fas fa-link icon-spacing"></i>2：聚合通用、Clash-meta、Sing-box订阅链接如下：</h3>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning" role="alert">
                        <h5 class="alert-heading"><i class="fas fa-exclamation-triangle icon-spacing"></i>注意：</h5>
                        <p>以下订阅链接仅6个TLS端口节点</p>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead class="table-light">
                            ...
                            <tbody>
                                <tr>
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${pty}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${pcl}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="copyToClipboard('${psb}')"><i class="fas fa-copy icon-spacing"></i>点击复制链接</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
