...
<title>Cloudflare Workers VLESS 代理</title>
<style>
* {
    margin: 0;
    padding: 0;
...
.tile-header::before {
    ...
    bottom: 0;
    opacity: 0.1;
    background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="30" fill="none" stroke="white" stroke-width="2"/></svg>') no-repeat center;
...
.tile-deep-blue { background: linear-gradient(135deg, #2980b9, #3498db); }
.tile-magenta { background: linear-gradient(135deg, #8e44ad, #9b59b6); }
.tile-orange { background: linear-gradient(135deg, #e67e22, #f39c12); }
.tile-cyan { background: linear-gradient(135deg, #16a085, #1abc9c); }
.tile-green { background: linear-gradient(135deg, #27ae60, #2ecc71); }
.tile-red { background: linear-gradient(135deg, #c0392b, #e74c3c); }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tileHeaders.forEach(header => {
        header.addEventListener('click', function(e) {
            ...
            const toggle = this.querySelector('.tile-toggle');
...
<div class="container">
    <div class="header">
        <h1>Cloudflare Workers VLESS 代理</h1>
        <div class="subtitle">V25.5.27 • 高性能代理解决方案</div>
    </div>
    ...
    <div class="tiles-grid">
        <!-- WS节点磁贴 -->
        <div class="tile">
            <div class="tile-header tile-deep-blue">
                <span>🔓 WS节点 (非TLS)</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <h5>节点特色</h5>
                    <p>关闭了TLS加密，无视域名阻断，适合高速传输</p>
                </div>
                
                <div class="config-item">
                    <h5>配置链接</h5>
                    <div class="config-link">${wvlessws}</div>
                    <button class="btn btn-copy" onclick="copyToClipboard('${wvlessws}')">复制链接</button>
                </div>
                
                <div class="parameters-list">
                    <h5>客户端参数</h5>
                    <ul>
                        <li><span class="param-key">地址</span><span class="param-value">自定义域名/优选IP</span></li>
                        <li><span class="param-key">端口</span><span class="param-value">80,8080,8880,2052,2082,2086,2095</span></li>
                        <li><span class="param-key">UUID</span><span class="param-value">${userID}</span></li>
                        <li><span class="param-key">传输</span><span class="param-value">WebSocket</span></li>
                        <li><span class="param-key">主机</span><span class="param-value">${hostName}</span></li>
                        <li><span class="param-key">路径</span><span class="param-value">/?ed=2560</span></li>
                        <li><span class="param-key">TLS</span><span class="param-value">关闭</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- WSS节点磁贴 -->
        <div class="tile">
            <div class="tile-header tile-magenta">
                <span>🔒 WSS节点 (TLS)</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <h5>节点特色</h5>
                    <p>启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启防域名阻断</p>
                </div>
                
                <div class="config-item">
                    <h5>配置链接</h5>
                    <div class="config-link">${pvlesswstls}</div>
                    <button class="btn btn-copy" onclick="copyToClipboard('${pvlesswstls}')">复制链接</button>
                </div>
                ...
                <div class="parameters-list">
                    ...
                    <ul>
                        <li><span class="param-key">地址</span><span class="param-value">自定义域名/优选IP</span></li>
                        <li><span class="param-key">端口</span><span class="param-value">443,8443,2053,2083,2087,2096</span></li>
                        <li><span class="param-key">UUID</span><span class="param-value">${userID}</span></li>
                        <li><span class="param-key">传输</span><span class="param-value">WebSocket</span></li>
                        <li><span class="param-key">主机</span><span class="param-value">${hostName}</span></li>
                        <li><span class="param-key">路径</span><span class="param-value">/?ed=2560</span></li>
                        <li><span class="param-key">TLS</span><span class="param-value">开启</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- 批量导入磁贴 -->
        <div class="tile">
            <div class="tile-header tile-orange">
                <span>📦 批量导入</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <h5>一键导入所有节点</h5>
                    <p>包含13个节点配置 (7个HTTP + 6个HTTPS)</p>
                    <button class="btn" onclick="copyToClipboard('${wkvlessshare}')">复制批量链接</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tiles-grid">
        <!-- 订阅链接磁贴 -->
        <div class="tile">
            <div class="tile-header tile-cyan">
                <span>🔗 订阅链接</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="notice">
                    ...
                    1. 默认每个订阅包含TLS+非TLS共13个端口节点<br>
                    2. 当前workers域名作为订阅链接，需通过代理更新<br>
                    3. 如客户端不支持分片功能，则TLS节点不可用
                </div>
                
                <div class="subscription-grid">
                    <div class="subscription-item">
                        <h6>通用订阅</h6>
                        <div class="config-link">${ty}</div>
                        <button class="btn" onclick="copyToClipboard('${ty}')">复制链接</button>
                    </div>
                    
                    <div class="subscription-item">
                        <h6>Clash Meta</h6>
                        <div class="config-link">${cl}</div>
                        <button class="btn" onclick="copyToClipboard('${cl}')">复制链接</button>
                    </div>
                    
                    <div class="subscription-item">
                        <h6>Sing-box</h6>
                        <div class="config-link">${sb}</div>
                        <button class="btn" onclick="copyToClipboard('${sb}')">复制链接</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="header">
        <h1>Cloudflare Pages VLESS 代理</h1>
        <div class="subtitle">V25.5.27 • 企业级代理解决方案</div>
    </div>
    ...
    <div class="tiles-grid">
        <!-- TLS节点磁贴 -->
        <div class="tile">
            <div class="tile-header tile-green">
                <span>🔒 TLS节点 (安全)</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <h5>节点特色</h5>
                    <p>启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启防域名阻断</p>
                </div>
        ...
        <!-- 批量导入磁贴 -->
        <div class="tile">
            <div class="tile-header tile-red">
                <span>📦 批量导入</span>
                <span class="tile-toggle">▼</span>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <h5>一键导入TLS节点</h5>
                    <p>包含6个HTTPS端口节点配置</p>
                    <button class="btn" onclick="copyToClipboard('${pgvlessshare}')">复制批量链接</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="tile">
            ...
            <div class="tile-content">
                ...
                <div class="subscription-grid">
                    <div class="subscription-item">
                        <h6>通用订阅</h6>
                        <div class="config-link">${pty}</div>
                        <button class="btn" onclick="copyToClipboard('${pty}')">复制链接</button>
                    </div>
                    
                    <div class="subscription-item">
                        <h6>Clash Meta</h6>
                        <div class="config-link">${pcl}</div>
                        <button class="btn" onclick="copyToClipboard('${pcl}')">复制链接</button>
                    </div>
                    
                    <div class="subscription-item">
                        <h6>Sing-box</h6>
                        <div class="config-link">${psb}</div>
                        <button class="btn" onclick="copyToClipboard('${psb}')">复制链接</button>
                    </div>
                </div>
            </div>
        </div>
