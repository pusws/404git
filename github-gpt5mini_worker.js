...
<head>
  ...
  <style>
    :root { --muted:#6c757d; --card-bg: #ffffff; --surface-shadow: 0 6px 24px rgba(16,24,40,0.08); }
    body { font-family: 'Inter', system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial; background: linear-gradient(180deg,#f6f8fb 0%, #ffffff 100%); color:#0f172a; -webkit-font-smoothing:antialiased; padding-top:28px; }
    .limited-width { max-width: 100%; word-break: break-word; }
    .card-modern { border: 0; border-radius: 12px; box-shadow: var(--surface-shadow); }
    .hero { margin-bottom: 1.25rem; }
    .node-badge { font-weight:600; font-size:.85rem; }
    .copy-btn { min-width: 120px; }
    .small-muted { color: var(--muted); font-size: .9rem; }
    .toast-container { position: fixed; top: 1rem; right: 1rem; z-index: 1080; }
    .mono { font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, "Roboto Mono", "Courier New", monospace; }
    @media (min-width: 992px) { .limited-width { max-width: 480px; } }
  </style>
</head>
<body>
  ...
  <script>
    ...
    function showToast(message, type='info') {
      ...
      const bg = type === 'success' ? 'success' : (type === 'warning' ? 'warning' : 'primary');
