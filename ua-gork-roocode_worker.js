...
<br>
${displayHtml}
<div class="ukraine-badge"></div>
<body>
<div class="ukraine-flag">
    <h2 style="color: white; text-align: center; margin: 0;">🇺🇦 乌克兰自由天空 🇺🇦</h2>
</div>
<div style="background: #FFD500; padding: 15px; margin: 20px 0; border: 3px solid #005BBB;">
    <p style="color: #005BBB; margin: 0; text-align: center; font-weight: 700; font-size: 16px;">
        ✊ 我们坚定支持乌克兰人民抵抗俄罗斯侵略的斗争！<br>
        🚫 强烈谴责俄罗斯对乌克兰的非法入侵和战争罪行！<br>
        🇺🇦 乌克兰必胜！正义必胜！自由必胜！
    </p>
</div>
<div class="container"></search>
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>🌟 Cloudflare Workers VLESS代理服务 V25.5.27 🌟</h1>
	    <div style="background: #005BBB; padding: 15px; border-radius: 10px; margin: 20px 0; border: 2px solid #FFD500;">
                <p style="color: #FFD500; margin: 0; text-align: center; font-weight: 600;">✨ 自由的网络，无国界的连接 ✨</p>
            </div>
            <p>${noteshow}</p>
            <hr>
	    <hr>
	    <hr>
            ...
            <br></search>
                        ...
                        <h3>🚀 1：Cloudflare Workers VLESS + WebSocket节点</h3></search>
</search_and_replace>
			<table class="table">
				<thead>
					<tr>
		...
		<li>传输安全(TLS)：关闭</li>
            ...
            <br>
            <br>
                        <h3>🔒 2：Cloudflare Workers VLESS + WebSocket + TLS节点</h3></search>
</search_and_replace>
			<table class="table">
				<thead>
					<tr>
			...
			<br>	
			<br>
			            <h3>📋 3：聚合订阅链接 (通用/Clash/Sing-box)</h3></search>
</search_and_replace>
			<hr>
...
<div class="container"></search>
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>🌟 Cloudflare Pages VLESS代理服务 V25.5.27 🌟</h1>
			<div style="background: #005BBB; padding: 15px; border-radius: 10px; margin: 20px 0; border: 2px solid #FFD500;">
                <p style="color: #FFD500; margin: 0; text-align: center; font-weight: 600;">✨ 自由的网络，无国界的连接 ✨</p>
            </div>
            <p>${noteshow}</p>
            ...
            <br></search>
                        ...
                        <h3>🔒 1：Cloudflare Pages/Workers VLESS + WebSocket + TLS节点</h3></search>
</search_and_replace>
			<table class="table">
				<thead>
					<tr>
            ...
            <br>
            <br>
						<h3>📋 2：聚合订阅链接 (通用/Clash/Sing-box)</h3></search>
</search_and_replace>
			<hr>
...
<div style="text-align: center; margin: 30px 0; padding: 20px; background: #005BBB; border-radius: 10px; border: 2px solid #FFD500;">
    <p style="color: #FFD500; margin: 0; font-weight: 600;">
        🇺🇦 为自由而战 | Stand with Ukraine 🇺🇦<br>
        <small style="font-size: 12px;">Made with ❤️ for freedom and open internet</small>
    </p>
</div>
</body>
`;
