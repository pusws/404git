...
body {
  ...
  background-color: #00abec; /* Win8 蓝色背景 */
  color: #ffffff;
  margin: 0;
  padding: 0;
}
...
.header {
  background-color: #0078d7; /* Win8 深蓝色标题栏 */
  padding: 20px;
  text-align: center;
...
.note {
  background-color: #d83b01; /* Win8 橙色提示 */
  padding: 15px;
  border-radius: 5px;
  margin-top: 20px;
}
    ...
    <div class="row">
	    ...
	    <hr>
            ...
            <div class="tile-container">
                <div class="tile" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">
                    <h3>CF-workers-\u0076\u006c\u0065\u0073\u0073+ws节点</h3>
                    <p>关闭了TLS加密，无视域名阻断</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">
                    <h3>CF-workers-\u0076\u006c\u0065\u0073\u0073+ws+tls节点</h3>
                    <p>启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">
                    <h3>聚合通用分享链接</h3>
                    <p>可直接导入客户端</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${ty}')">
                    <h3>聚合通用订阅链接</h3>
                    <p>默认每个订阅链接包含TLS+非TLS共13个端口节点</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${cl}')">
                    <h3>Clash-meta订阅链接</h3>
                    <p>当前workers域名作为订阅链接，需通过代理进行订阅更新</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${sb}')">
                    <h3>Sing-box订阅链接</h3>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-container">
                ...
                <div class="tile" onclick="copyToClipboard('${pty}')">
                    <h3>聚合通用订阅链接</h3>
                    <p>以下订阅链接仅6个TLS端口节点</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${pcl}')">
                    <h3>Clash-meta订阅链接</h3>
                    <p>当前workers域名作为订阅链接，需通过代理进行订阅更新</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
                <div class="tile" onclick="copyToClipboard('${psb}')">
                    <h3>Sing-box订阅链接</h3>
                    <p>如使用的客户端不支持分片功能，则TLS节点不可用</p>
                    <button class="copy-button">点击复制链接</button>
                </div>
