...
.metro-tile.blue { background: #0078d4; }
.metro-tile.green { background: #107c10; }
.metro-tile.orange { background: #ff8c00; }
.metro-tile.purple { background: #5c2d91; }
.metro-tile.red { background: #d13438; }
.metro-tile.teal { background: #008272; }
.metro-tile.yellow { background: #ffb900; }
.metro-tile.pink { background: #e3008c; }
...
<div class="metro-container">
    <div class="metro-header">
        <h1 class="metro-title">VLESS 代理配置</h1>
        <p class="metro-subtitle">Cloudflare Workers/Pages 代理脚本 V25.5.27</p>
    </div>
    ...
    <div class="metro-section">
        ...
        <div class="metro-grid">
            <div class="metro-tile blue large" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">
                <div class="tile-icon">🔗</div>
                <div class="tile-title">WS 节点 (HTTP)</div>
                <div class="tile-content">关闭TLS加密，无视域名阻断</div>
                <div class="tile-badge">HTTP</div>
            </div>

            <div class="metro-tile green" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">
                <div class="tile-icon">🔒</div>
                <div class="tile-title">WS+TLS 节点</div>
                <div class="tile-content">启用TLS加密</div>
                <div class="tile-badge">HTTPS</div>
            </div>
        </div>
    </div>
    ...
    <div class="metro-section">
        ...
        <div class="metro-grid">
            <div class="metro-tile orange" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">
                <div class="tile-icon">📋</div>
                <div class="tile-title">通用分享链接</div>
                <div class="tile-content">可直接导入客户端</div>
                <div class="tile-badge">13节点</div>
            </div>

            <div class="metro-tile purple" onclick="copyToClipboard('${ty}')">
                <div class="tile-icon">🔄</div>
                <div class="tile-title">通用订阅</div>
                <div class="tile-content">自动更新节点</div>
            </div>

            <div class="metro-tile teal" onclick="copyToClipboard('${cl}')">
                <div class="tile-icon">⚡</div>
                <div class="tile-title">Clash Meta</div>
                <div class="tile-content">Clash 客户端配置</div>
            </div>

            <div class="metro-tile pink" onclick="copyToClipboard('${sb}')">
                <div class="tile-icon">📦</div>
                <div class="tile-title">Sing-box</div>
                <div class="tile-content">Sing-box 客户端配置</div>
            </div>
        </div>
    </div>
    <div class="metro-section">
        ...
        <div class="metro-grid">
            <div class="metro-tile yellow tall">
                <div class="tile-icon">⚙️</div>
                <div class="tile-title">WS 节点参数</div>
                <div class="tile-content">
                    <div style="margin-bottom: 8px;"><strong>用户ID:</strong> ${userID}</div>
                    <div style="margin-bottom: 8px;"><strong>伪装域名:</strong> ${hostName}</div>
                    <div style="margin-bottom: 8px;"><strong>路径:</strong> /?ed=2560</div>
                    <div style="margin-bottom: 8px;"><strong>HTTP端口:</strong> 80,8080,8880,2052,2082,2086,2095</div>
                    <div><strong>传输安全:</strong> 关闭</div>
                </div>
            </div>

            <div class="metro-tile red tall">
                <div class="tile-icon">🔐</div>
                <div class="tile-title">WS+TLS 节点参数</div>
                <div class="tile-content">
                    <div style="margin-bottom: 8px;"><strong>用户ID:</strong> ${userID}</div>
                    <div style="margin-bottom: 8px;"><strong>伪装域名:</strong> ${hostName}</div>
                    <div style="margin-bottom: 8px;"><strong>路径:</strong> /?ed=2560</div>
                    <div style="margin-bottom: 8px;"><strong>HTTPS端口:</strong> 443,8443,2053,2083,2087,2096</div>
                    <div><strong>传输安全:</strong> 开启</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="metro-container">
    <div class="metro-header">
        <h1 class="metro-title">VLESS 代理配置</h1>
        <p class="metro-subtitle">Cloudflare Pages/Workers 自定义域名 V25.5.27</p>
    </div>
    ...
    <div class="metro-section">
        <h2 class="section-title">TLS 安全节点</h2>
        <div class="metro-grid">
            <div class="metro-tile green large" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">
                <div class="tile-icon">🔒</div>
                <div class="tile-title">WS+TLS 节点</div>
                <div class="tile-content">启用TLS加密，支持分片功能防域名阻断</div>
                <div class="tile-badge">HTTPS</div>
            </div>
        </div>
    </div>
    ...
    <div class="metro-section">
        <h2 class="section-title">订阅链接</h2>
        <div class="metro-grid">
            <div class="metro-tile orange" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">
                <div class="tile-icon">📋</div>
                <div class="tile-title">通用分享链接</div>
                <div class="tile-content">可直接导入客户端</div>
                <div class="tile-badge">6节点</div>
            </div>

            <div class="metro-tile purple" onclick="copyToClipboard('${pty}')">
                <div class="tile-icon">🔄</div>
                <div class="tile-title">通用订阅</div>
                <div class="tile-content">自动更新节点</div>
            </div>

            <div class="metro-tile teal" onclick="copyToClipboard('${pcl}')">
                <div class="tile-icon">⚡</div>
                <div class="tile-title">Clash Meta</div>
                <div class="tile-content">Clash 客户端配置</div>
            </div>

            <div class="metro-tile pink" onclick="copyToClipboard('${psb}')">
                <div class="tile-icon">📦</div>
                <div class="tile-title">Sing-box</div>
                <div class="tile-content">Sing-box 客户端配置</div>
            </div>
    ...
    <div class="metro-section">
        ...
        <div class="metro-grid">
            <div class="metro-tile red tall">
                <div class="tile-icon">🔐</div>
                <div class="tile-title">TLS 节点参数</div>
                <div class="tile-content">
                    <div style="margin-bottom: 8px;"><strong>用户ID:</strong> ${userID}</div>
                    <div style="margin-bottom: 8px;"><strong>伪装域名:</strong> ${hostName}</div>
                    <div style="margin-bottom: 8px;"><strong>路径:</strong> /?ed=2560</div>
