...
<title>Cloudflare Workers/Pages VLESS 代理</title>
...
function copyToClipboard(text) {
  navigator.clipboard.writeText(text).then(() => {
    ...
    toast.innerHTML = '<i class="bi bi-check-circle-fill me-2"></i> 已成功复制到剪贴板';
...
<div class="container">
    <div class="row">
	    ...
	    <!-- 提示信息 -->
            <div class="note-card">
                <h5><i class="bi bi-info-circle-fill"></i> 重要提示</h5>
                <p>${noteshow}</p>
            </div>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-copy" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制</button></td>
					</tr>
				</tbody>
			</table>
            <h5>客户端参数如下：</h5>
		...
		<li>传输安全(TLS)：关闭</li>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-copy" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制</button></td>
					</tr>
				</tbody>
			</table>
            <h5>客户端参数如下：</h5>
			...
			<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><button class="btn btn-copy" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制</button></td>
						</tr>
					</tbody>
				</table>
			...
			<table class="table table-hover">
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-copy" onclick="copyToClipboard('${ty}')">复制</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><button class="btn btn-copy" onclick="copyToClipboard('${cl}')">复制</button></td>
							</tr>
						</tbody>
					</table>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-copy" onclick="copyToClipboard('${sb}')">复制</button></td>
						</tr>
					</tbody>
				</table>
				<br>
    ...
    <div class="footer text-center">
        <p class="mb-0">© 2025 Cloudflare Workers/Pages VLESS 代理脚本 | 甬哥作品</p>
        <div class="mt-2">
            <a href="https://ygkkk.blogspot.com" target="_blank" class="text-decoration-none me-3">
                <i class="bi bi-globe"></i> 博客
            </a>
            <a href="https://www.youtube.com/@ygkkk" target="_blank" class="text-decoration-none me-3">
                <i class="bi bi-youtube"></i> YouTube
            </a>
            <a href="https://t.me/ygkkktg" target="_blank" class="text-decoration-none me-3">
                <i class="bi bi-telegram"></i> TG群组
            </a>
            <a href="https://t.me/ygkkktgpd" target="_blank" class="text-decoration-none">
                <i class="bi bi-send"></i> TG频道
            </a>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
			...
			<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><button class="btn btn-copy" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制</button></td>
						</tr>
					</tbody>
				</table>
			...
			<table class="table table-hover">
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-copy" onclick="copyToClipboard('${pty}')">复制</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><button class="btn btn-copy" onclick="copyToClipboard('${pcl}')">复制</button></td>
							</tr>
						</tbody>
					</table>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-copy" onclick="copyToClipboard('${psb}')">复制</button></td>
						</tr>
					</tbody>
				</table>
				<br>
