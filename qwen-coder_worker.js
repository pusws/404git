...
.copy-modal-content button:hover {
...
// Add notification badges to some tiles
...
<div class="container">
  ...
  <div class="tiles-container">
    <!-- VLESS+WS Tile -->
    <div class="tile ws" onclick="copyToClipboard('${wvlessws}')">
      <div>
        <div class="icon">📡</div>
        <div class="title">VLESS + WS</div>
        <div class="subtitle">无 TLS 加密</div>
      </div>
      <div class="notification" style="display: none;">1</div>
    </div>
    
    <!-- VLESS+WS+TLS Tile -->
    <div class="tile wstls" onclick="copyToClipboard('${pvlesswstls}')">
      <div>
        <div class="icon">🔒</div>
        <div class="title">VLESS + WS + TLS</div>
        <div class="subtitle">启用 TLS 加密</div>
      </div>
      <div class="notification" style="display: none;">2</div>
    </div>
    
    <!-- Universal Subscription Tile -->
    <div class="tile ty large" onclick="copyToClipboard('${ty}')">
      <div>
        <div class="icon">📋</div>
        <div class="title">通用订阅</div>
        <div class="subtitle">包含 13 个节点</div>
      </div>
      <div class="notification" style="display: none;">3</div>
    </div>
    
    <!-- Clash-meta Subscription Tile -->
    <div class="tile cl" onclick="copyToClipboard('${cl}')">
      <div>
        <div class="icon">⚔️</div>
        <div class="title">Clash-meta</div>
        <div class="subtitle">订阅链接</div>
      </div>
      <div class="notification" style="display: none;">4</div>
    </div>
    
    <!-- Sing-box Subscription Tile -->
    <div class="tile sb" onclick="copyToClipboard('${sb}')">
      <div>
        <div class="icon">📦</div>
        <div class="title">Sing-box</div>
        <div class="subtitle">订阅链接</div>
      </div>
      <div class="notification" style="display: none;">5</div>
    </div>
    
    <!-- Universal Share Link Tile -->
    <div class="tile" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073share}')">
      <div>
        <div class="icon">🔗</div>
        <div class="title">通用分享</div>
        <div class="subtitle">可直接导入</div>
      </div>
      <div class="notification" style="display: none;">6</div>
    </div>
  </div>
  
  <div class="footer">
    <p>Cloudflare-workers/pages-vless代理脚本 V25.5.27</p>
    <p>注意：默认每个订阅链接包含TLS+非TLS共13个端口节点</p>
    <p>当前workers域名作为订阅链接，需通过代理进行订阅更新</p>
    <p>如使用的客户端不支持分片功能，则TLS节点不可用</p>
  </div>
  
  <div class="copy-modal" id="copyModal" onclick="closeCopyModal()">
    <div class="copy-modal-content" onclick="event.stopPropagation()">
      <h2>已复制到剪贴板</h2>
      <p id="modalText"></p>
      <button onclick="closeCopyModal()">确定</button>
    </div>
  </div>
</div>
</body>
...
<div class="container">
  ...
  <div class="tiles-container">
    <!-- VLESS+WS+TLS Tile -->
    <div class="tile wstls large" onclick="copyToClipboard('${pvlesswstls}')">
      <div>
        <div class="icon">🔒</div>
        <div class="title">VLESS + WS + TLS</div>
        <div class="subtitle">自定义域节点</div>
      </div>
      <div class="notification" style="display: none;">1</div>
    </div>
    
    <!-- Universal Subscription Tile -->
    <div class="tile ty" onclick="copyToClipboard('${pty}')">
      <div>
        <div class="icon">📋</div>
        <div class="title">通用订阅</div>
        <div class="subtitle">TLS 节点</div>
      </div>
      <div class="notification" style="display: none;">2</div>
    </div>
    
    <!-- Clash-meta Subscription Tile -->
    <div class="tile cl" onclick="copyToClipboard('${pcl}')">
      <div>
        <div class="icon">⚔️</div>
        <div class="title">Clash-meta</div>
        <div class="subtitle">订阅链接</div>
    ...
    <!-- Sing-box Subscription Tile -->
    <div class="tile sb" onclick="copyToClipboard('${psb}')">
      <div>
        <div class="icon">📦</div>
        <div class="title">Sing-box</div>
        <div class="subtitle">订阅链接</div>
    ...
    <!-- Universal Share Link Tile -->
    <div class="tile" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">
      <div>
        <div class="icon">🔗</div>
        <div class="title">通用分享</div>
        <div class="subtitle">可直接导入</div>
