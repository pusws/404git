...
function switchTab(tabName) {
  ...
  document.getElementById('wstls-content').style.display = 'none';
  document.getElementById('subscribe-content').style.display = 'none';
  
  // Remove active class from all tabs
  document.getElementById('ws-tab').classList.remove('active');
  document.getElementById('wstls-tab').classList.remove('active');
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 mb-4">
            <h1 class="neumorphic-title">Cloudflare Workers VLESS 代理脚本</h1>
            <p class="neumorphic-text text-center">V25.5.27</p>
        </div>
        
        <div class="col-12 mb-4">
            <div class="neumorphic-card">
                <h3 class="neumorphic-subtitle">📘 使用说明</h3>
                <p class="neumorphic-text">${noteshow}</p>
            </div>
        </div>

        <div class="col-12">
            <div class="neumorphic-tab-container">
                <div class="d-flex flex-wrap">
                    <div class="neumorphic-tab active" id="ws-tab" onclick="switchTab('ws')">WS 节点</div>
                    <div class="neumorphic-tab" id="wstls-tab" onclick="switchTab('wstls')">WS+TLS 节点</div>
                    <div class="neumorphic-tab" id="subscribe-tab" onclick="switchTab('subscribe')">订阅链接</div>
                </div>
            </div>
            
            <div id="ws-content">
                <div class="neumorphic-card">
                    <h4 class="neumorphic-subtitle">📡 CF-workers-VLESS+ws 节点</h4>
                    <div class="neumorphic-badge">关闭了TLS加密，无视域名阻断</div>
                    <div class="neumorphic-input">
                        <small class="text-muted">节点链接：</small><br>
                        ${w\u0076\u006c\u0065\u0073\u0073ws}
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    <h5 class="neumorphic-subtitle mt-4">📋 客户端参数</h5>
                    <ul class="neumorphic-list neumorphic-text">
            ...
            <div id="wstls-content" style="display: none;">
                <div class="neumorphic-card">
                    <h4 class="neumorphic-subtitle">🔒 CF-workers-VLESS+ws+tls 节点</h4>
                    <div class="neumorphic-badge">启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</div>
                    <div class="neumorphic-input">
                        <small class="text-muted">节点链接：</small><br>
                        ${p\u0076\u006c\u0065\u0073\u0073wstls}
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    <h5 class="neumorphic-subtitle mt-4">📋 客户端参数</h5>
                    <ul class="neumorphic-list neumorphic-text">
            ...
            <div id="subscribe-content" style="display: none;">
                <div class="neumorphic-card">
                    <h4 class="neumorphic-subtitle">🔗 聚合通用、Clash-meta、Sing-box 订阅链接</h4>
                    ...
                    <div class="neumorphic-input">
                        <small class="text-muted">聚合通用分享链接 (可直接导入客户端)</small><br>
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    
                    <div class="neumorphic-input mt-3">
                        <small class="text-muted">聚合通用订阅链接</small><br>
                        ${ty}
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${ty}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    
                    <div class="neumorphic-input mt-3">
                        <small class="text-muted">Clash-meta订阅链接</small><br>
                        ${cl}
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${cl}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    
                    <div class="neumorphic-input mt-3">
                        <small class="text-muted">Sing-box订阅链接</small><br>
                        ${sb}
                    </div>
                    <button class="neumorphic-btn" onclick="copyToClipboard('${sb}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                </div>
            </div>
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-12">
            <div id="wstls-content">
                <div class="neumorphic-card">
                    <h4 class="neumorphic-subtitle">🔒 CF-pages/workers/自定义域-VLESS+ws+tls 节点</h4>
                    <div class="neumorphic-badge">启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</div>
                    <div class="neumorphic-input">
                        <small class="text-muted">节点链接：</small><br>
                        ${p\u0076\u006c\u0065\u0073\u0073wstls}
                    </div>
            ...
            <div id="subscribe-content" class="mt-4">
                <div class="neumorphic-card">
                    <h4 class="neumorphic-subtitle">🔗 聚合通用、Clash-meta、Sing-box 订阅链接</h4>
                    <div class="neumorphic-alert">
                    ...
                    <button class="neumorphic-btn" onclick="copyToClipboard(atob('${pg\u0076\u006c\u0065\u0073\u0073share}'))">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    ...
                    <button class="neumorphic-btn" onclick="copyToClipboard('${pty}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    ...
                    <button class="neumorphic-btn" onclick="copyToClipboard('${pcl}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                    ...
                    <button class="neumorphic-btn" onclick="copyToClipboard('${psb}')">
                        <i class="fas fa-copy me-1"></i>复制链接
                    </button>
                </div>
            </div>
