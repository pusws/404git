...
<div class="container my-5">
    <div class="card mb-4">
        <div class="card-header text-center">
            <h1 class="mb-0">Cloudflare-workers/pages-\u0076\u006c\u0065\u0073\u0073代理脚本 V25.5.27</h1>
        </div>
        <div class="card-body">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h3 class="mb-0"><i class="bi bi-plug me-2"></i>1：CF-workers-\u0076\u006c\u0065\u0073\u0073+ws节点</h3>
        </div>
        <div class="card-body">
            <p class="card-text"><strong>节点特色：</strong> 关闭了TLS加密，无视域名阻断</p>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${w\u0076\u006c\u0065\u0073\u0073ws}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')"><i class="bi bi-clipboard me-2"></i>复制链接</button>
            </div>
            <h5 class="mt-4">客户端参数：</h5>
            <ul class="list-group">
                <li class="list-group-item">地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
                <li class="list-group-item">端口(port)：7个http端口可任意选择(80、8080、8880、2052、2082、2086、2095)，或反代IP对应端口</li>
                <li class="list-group-item">用户ID(uuid)：${userID}</li>
                <li class="list-group-item">传输协议(network)：ws 或者 websocket</li>
                <li class="list-group-item">伪装域名(host)：${hostName}</li>
                <li class="list-group-item">路径(path)：/?ed=2560</li>
                <li class="list-group-item">传输安全(TLS)：关闭</li>
            </ul>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h3 class="mb-0"><i class="bi bi-shield-lock me-2"></i>2：CF-workers-\u0076\u006c\u0065\u0073\u0073+ws+tls节点</h3>
        </div>
        <div class="card-body">
            <p class="card-text"><strong>节点特色：</strong> 启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</p>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${p\u0076\u006c\u0065\u0073\u0073wstls}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')"><i class="bi bi-clipboard me-2"></i>复制链接</button>
            </div>
            <h5 class="mt-4">客户端参数：</h5>
            <ul class="list-group">
                <li class="list-group-item">地址(address)：自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</li>
                <li class="list-group-item">端口(port)：6个https端口可任意选择(443、8443、2053、2083、2087、2096)，或反代IP对应端口</li>
                <li class="list-group-item">用户ID(uuid)：${userID}</li>
                <li class="list-group-item">传输协议(network)：ws 或者 websocket</li>
                <li class="list-group-item">伪装域名(host)：${hostName}</li>
                <li class="list-group-item">路径(path)：/?ed=2560</li>
                <li class="list-group-item">传输安全(TLS)：开启</li>
                <li class="list-group-item">跳过证书验证(allowlnsecure)：false</li>
            </ul>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0"><i class="bi bi-cloud-download me-2"></i>3：聚合订阅链接</h3>
        </div>
        <div class="card-body">
            <div class="alert alert-warning" role="alert">
                注意：<br>1、默认每个订阅链接包含TLS+非TLS共13个端口节点<br>2、当前workers域名作为订阅链接，需通过代理进行订阅更新<br>3、如使用的客户端不支持分片功能，则TLS节点不可用
            </div>
            <h5>聚合通用分享链接 (可直接导入客户端)：</h5>
            <div class="input-group mb-3">
                <button class="btn btn-success btn-copy w-100" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')"><i class="bi bi-clipboard me-2"></i>复制链接</button>
            </div>
            <h5>聚合通用订阅链接：</h5>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${ty}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${ty}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
            <h5>Clash-meta订阅链接：</h5>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${cl}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${cl}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
            <h5>Sing-box订阅链接：</h5>
            <div class="input-group">
                <input type="text" class="form-control limited-width" value="${sb}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${sb}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container my-5">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h3 class="mb-0"><i class="bi bi-shield-lock me-2"></i>1：CF-pages/workers/自定义域-\u0076\u006c\u0065\u0073\u0073+ws+tls节点</h3>
        </div>
        <div class="card-body">
            <p class="card-text"><strong>节点特色：</strong> 启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</p>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${p\u0076\u006c\u0065\u0073\u0073wstls}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')"><i class="bi bi-clipboard me-2"></i>复制链接</button>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0"><i class="bi bi-cloud-download me-2"></i>2：聚合订阅链接</h3>
        </div>
        <div class="card-body">
            <div class="alert alert-warning" role="alert">
                注意：以下订阅链接仅6个TLS端口节点
            ...
            <h5>聚合通用分享链接 (可直接导入客户端)：</h5>
            <div class="input-group mb-3">
                <button class="btn btn-success btn-copy w-100" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')"><i class="bi bi-clipboard me-2"></i>复制链接</button>
            </div>
            <h5>聚合通用订阅链接：</h5>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${pty}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${pty}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
            <h5>Clash-meta订阅链接：</h5>
            <div class="input-group mb-3">
                <input type="text" class="form-control limited-width" value="${pcl}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${pcl}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
            <h5>Sing-box订阅链接：</h5>
            <div class="input-group">
                <input type="text" class="form-control limited-width" value="${psb}" readonly>
                <button class="btn btn-primary btn-copy" onclick="copyToClipboard('${psb}')"><i class="bi bi-clipboard me-2"></i>复制</button>
            </div>
        </div>
    </div>
</div>
