...
<div class="container">
    <div class="row">
        <div class="ios-header">
			<h1 class="ios-title">vless代理配置</h1>
			<p class="ios-subtitle">Cloudflare Workers 代理脚本 V25.5.27</p>
		</div>
		...
		<div class="ios-section">
			<h2 class="ios-section-title">CF-workers-vless+ws节点</h2>
			<div class="ios-card">
				<div class="ios-card-header">
					关闭了TLS加密，无视域名阻断
				</div>
				<div class="ios-card-body">
					<div class="ios-config-item">
						<div class="ios-config-label">节点链接</div>
						<div class="ios-config-value">${wvlessws}</div>
					</div>
					<button class="ios-button" onclick="copyToClipboard('${wvlessws}')">复制节点链接</button>
					
					<div style="margin-top: 20px;">
						<h4 style="margin-bottom: 15px; color: #1d1d1f;">客户端参数</h4>
						<div class="ios-grid">
							<div class="ios-config-item">
								<div class="ios-config-label">客户端地址</div>
								<div class="ios-config-value">自定义的域名 或者 优选域名 或者 优选IP 或者 反代IP</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">端口</div>
								<div class="ios-config-value">7个http端口可任意选择(80、8080、8880、2052、2082、2086、2095)</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">用户ID</div>
								<div class="ios-config-value">${userID}</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">传输协议</div>
								<div class="ios-config-value">ws 或者 websocket</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">伪装域名</div>
								<div class="ios-config-value">${hostName}</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">路径</div>
								<div class="ios-config-value">/?ed=2560</div>
							</div>
							<div class="ios-config-item">
								<div class="ios-config-label">传输安全</div>
								<div class="ios-config-value">关闭</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="ios-section">
				<h2 class="ios-section-title">CF-workers-vless+ws+tls节点</h2>
				<div class="ios-card">
					<div class="ios-card-header">
						启用了TLS加密，如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断
					</div>
					<div class="ios-card-body">
						<div class="ios-config-item">
							<div class="ios-config-label">节点链接</div>
							<div class="ios-config-value">${pvlesswstls}</div>
						</div>
						<button class="ios-button" onclick="copyToClipboard('${pvlesswstls}')">复制节点链接</button>
						...
						<div style="margin-top: 20px;">
							...
							<div class="ios-grid">
								...
								<div class="ios-config-item">
									<div class="ios-config-label">端口</div>
									<div class="ios-config-value">6个https端口可任意选择(443、8443、2053、2083、2087、2096)</div>
								</div>
								<div class="ios-config-item">
									<div class="ios-config-label">用户ID</div>
									<div class="ios-config-value">${userID}</div>
								...
								<div class="ios-config-item">
									<div class="ios-config-label">传输安全</div>
									<div class="ios-config-value">开启</div>
								</div>
								<div class="ios-config-item">
									<div class="ios-config-label">跳过证书验证</div>
									<div class="ios-config-value">false</div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="ios-section">
				<h2 class="ios-section-title">订阅链接</h2>
				<div class="ios-card">
					<div class="ios-card-header">
						聚合通用、Clash-meta、Sing-box订阅
					</div>
					<div class="ios-card-body">
						<div class="ios-note">
							<strong>注意：</strong><br>
						...
						<div class="ios-link-item">
							<div class="ios-link-label">聚合通用分享链接</div>
							<div class="ios-link-desc">可直接导入客户端</div>
							<button class="ios-button" onclick="copyToClipboard('${wkvlessshare}')">复制链接</button>
						</div>

						<div class="ios-link-item">
							<div class="ios-link-label">聚合通用订阅链接</div>
							<div class="ios-link-value">${ty}</div>
							<button class="ios-button" onclick="copyToClipboard('${ty}')">复制链接</button>
						</div>

						<div class="ios-link-item">
							<div class="ios-link-label">Clash-meta订阅链接</div>
							<div class="ios-link-value">${cl}</div>
							<button class="ios-button" onclick="copyToClipboard('${cl}')">复制链接</button>
						</div>

						<div class="ios-link-item">
							<div class="ios-link-label">Sing-box订阅链接</div>
							<div class="ios-link-value">${sb}</div>
							<button class="ios-button" onclick="copyToClipboard('${sb}')">复制链接</button>
						</div>
					</div>
				</div>
			</div>
...
<div class="ios-container">
  ...
  <div class="ios-note">
    <strong>甬哥博客地址：</strong>https://ygkkk.blogspot.com<br>
    <strong>甬哥YouTube频道：</strong>https://www.youtube.com/@ygkkk<br>
    <strong>甬哥TG电报群组：</strong>https://t.me/ygkkktg<br>
    <strong>甬哥TG电报频道：</strong>https://t.me/ygkkktgpd<br>
    <br>
    <strong>ProxyIP使用nat64自动生成，无需设置</strong>
  </div>

  <div class="ios-section">
    <h2 class="ios-section-title">CF-pages/workers/自定义域-vless+ws+tls节点</h2>
    <div class="ios-card">
      <div class="ios-card-header">
        启用了TLS加密，如果客户端支持分片(Fragment)功能，可开启，防止域名阻断
      </div>
      <div class="ios-card-body">
        <div class="ios-config-item">
          <div class="ios-config-label">节点链接</div>
  ...
  <div class="ios-section">
    ...
    <div class="ios-card">
      ...
      <div class="ios-card-body">
        <div class="ios-note">
          <strong>注意：</strong>以下订阅链接仅6个TLS端口节点
        </div>

        <div class="ios-link-item">
          <div class="ios-link-url">${pgvlessshare}</div>
          <button class="ios-button" onclick="copyToClipboard('${pgvlessshare}')">复制分享链接</button>
        </div>

        <div class="ios-link-item">
          <div class="ios-link-url">${pty}</div>
          <button class="ios-button" onclick="copyToClipboard('${pty}')">复制订阅链接</button>
        </div>

        <div class="ios-link-item">
          <div class="ios-link-url">${pcl}</div>
          <button class="ios-button" onclick="copyToClipboard('${pcl}')">复制Clash订阅</button>
        </div>

        <div class="ios-link-item">
          <div class="ios-link-url">${psb}</div>
          <button class="ios-button" onclick="copyToClipboard('${psb}')">复制Sing-box订阅</button>
        </div>
      </div>
    </div>
  </div>
