...
.tile-orange { background-color: #d83b01; }
.tile-purple { background-color: #5c2d91; }
...
<body>
<div class="container">
    <h1 style="text-align: center; font-size: 2.5em; margin-bottom: 20px;">Cloudflare Workers VLESS代理脚本</h1>
    ...
    <div class="tile-grid">
      ...
      <div class="tile tile-blue tile-large">
        <div class="tile-header">
          <span class="tile-icon">📡</span>
          <span>CF-workers-vless+ws节点</span>
        </div>
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制链接</button>
        </div>
      </div>
      
      <!-- 客户端参数 -->
      <div class="tile tile-green tile-medium">
        <div class="tile-header">
      ...
      <!-- 端口信息 -->
      <div class="tile tile-orange tile-medium">
        <div class="tile-header">
          <span class="tile-icon">🔌</span>
          <span>端口信息</span>
        </div>
        <div class="tile-content">
          <p>HTTP端口:</p>
          <p>80, 8080, 8880, 2052</p>
          <p>2082, 2086, 2095</p>
        </div>
      </div>
      
      <!-- CF-workers-vless+ws+tls节点 -->
      <div class="tile tile-purple tile-large">
        <div class="tile-header">
          <span class="tile-icon">🔒</span>
          <span>CF-workers-vless+ws+tls节点</span>
        </div>
        <div class="tile-content">
          <p>启用了TLS加密<br>如果客户端支持分片(Fragment)功能，建议开启，防止域名阻断</p>
          <div class="live-tile">
            <div class="notification">2</div>
          </div>
        </div>
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button>
        </div>
      </div>
      
      <!-- TLS客户端参数 -->
      <div class="tile tile-teal tile-medium">
        <div class="tile-header">
          <span class="tile-icon">🔧</span>
          <span>TLS客户端参数</span>
        </div>
      ...
      <!-- TLS端口信息 -->
      <div class="tile tile-red tile-medium">
        <div class="tile-header">
          <span class="tile-icon">🛡️</span>
          <span>TLS端口信息</span>
        </div>
      ...
      <div class="tile tile-blue tile-large">
        ...
        <div class="tile-content">
          <p>默认每个订阅链接包含TLS+非TLS共13个端口节点</p>
          <p>当前workers域名作为订阅链接，需通过代理进行订阅更新</p>
          <p>如使用的客户端不支持分片功能，则TLS节点不可用</p>
        </div>
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${ty}')">复制链接</button>
        </div>
      </div>
      ...
      <div class="tile tile-green tile-medium">
        <div class="tile-header">
          <span class="tile-icon">📱</span>
          <span>Clash-meta订阅</span>
        </div>
        <div class="tile-content">
          <p>适用于Clash-meta客户端</p>
        </div>
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${cl}')">复制链接</button>
        </div>
      </div>
      ...
      <div class="tile tile-orange tile-medium">
        <div class="tile-header">
          <span class="tile-icon">📦</span>
          <span>Sing-box订阅</span>
        </div>
        <div class="tile-content">
          <p>适用于Sing-box客户端</p>
        </div>
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${sb}')">复制链接</button>
        </div>
      </div>
      
      <!-- 通用分享链接 -->
      <div class="tile tile-purple tile-medium">
        <div class="tile-header">
          <span class="tile-icon">📤</span>
          <span>通用分享链接</span>
        </div>
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制链接</button>
        </div>
      </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="tile-grid">
      ...
      <div class="tile tile-blue tile-large">
        <div class="tile-header">
          <span class="tile-icon">🔒</span>
          <span>CF-pages/workers/自定义域-vless+ws+tls节点</span>
        </div>
        <div class="tile-content">
          <p>启用了TLS加密<br>如果客户端支持分片(Fragment)功能，可开启，防止域名阻断</p>
          <div class="live-tile">
            <div class="notification">1</div>
          </div>
        </div>
      ...
      <div class="tile tile-purple tile-large">
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${pty}')">复制链接</button>
        </div>
      </div>
      ...
      <div class="tile tile-teal tile-medium">
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${pcl}')">复制链接</button>
        </div>
      </div>
      ...
      <div class="tile tile-red tile-medium">
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${psb}')">复制链接</button>
        </div>
      </div>
      
      <!-- 通用分享链接 -->
      <div class="tile tile-blue tile-medium">
        <div class="tile-header">
          <span class="tile-icon">📤</span>
          <span>通用分享链接</span>
        </div>
        ...
        <div class="tile-footer">
          <button class="tile-button" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制链接</button>
        </div>
      </div>
    </div>
</div>
