...
function get\u0076\u006c\u0065\u0073\u0073Config(userID, hostName) {
  ...
  <style>
  :root {
    /* Core Style: Neumorphism / Soft UI with Minimalist 3D */
    --bg: #e9edf4;
    --bg-hi: #f6f9ff;
    --shadow-dark: #c8d0e7; /* diffuse outer shadow */
    --shadow-light: #ffffff; /* soft highlight */
    --text: #5f6b7a;
    --muted: #7b8798;
    --accent: #6c8cff;
  }
  ...
  body {
    background: linear-gradient(145deg, var(--bg), var(--bg-hi));
    color: var(--text);
  ...
  /* Soft, tactile containers */
  .neo-surface {
    background: var(--bg);
    border-radius: 18px;
    box-shadow: 14px 14px 28px var(--shadow-dark), -14px -14px 28px var(--shadow-light); /* outer shadow (extruded/embossed) */
  }

  .neo-inset {
    background: var(--bg);
    border-radius: 18px;
    box-shadow: inset 12px 12px 24px var(--shadow-dark), inset -12px -12px 24px var(--shadow-light); /* inner shadow (pressed/inset/concave) */
  }

  /* Tables become Clay/Neumorphic cards */
  .table {
    background: var(--bg);
    border-radius: 16px;
  ...
  .table > :not(caption) > * > * {
    ...
    box-shadow: none;
    border-bottom: 1px solid rgba(100, 113, 132, 0.06);
  }

  .table thead th {
    background: linear-gradient(180deg, var(--bg-hi), var(--bg));
    border: 0 !important;
  }
...
<div class="container">
    <div class="row section">
        <div class="col-md-12 neo-surface p-4 p-md-5 rounded-4">
	    ...
	    <hr>
			...
			<div class="neo-surface p-3 mb-4"><table class="table mb-0">
				<thead>
					<tr>
						<th>节点特色：</th>
						<th>单节点链接如下：</th>
				...
				<tbody>
					<tr>
						...
						<td class="limited-width"><div class="neo-inset p-2 rounded">${w\u0076\u006c\u0065\u0073\u0073ws}</div></td>
		...
		<li>传输安全(TLS)：关闭</li>
			...
			<div class="neo-surface p-3 mb-4"><table class="table mb-0">
				...
				<tbody>
					<tr>
						...
						<td class="limited-width"><div class="neo-inset p-2 rounded">${p\u0076\u006c\u0065\u0073\u0073wstls}</div></td>
			...
			<div class="neo-surface p-3 mb-4"><table class="table mb-0">
					...
					<tbody>
						<tr>
							<td class="limited-width"><div class="neo-inset p-2 rounded">${ty}</div></td>
				...
				<table class="table">
					...
					<tbody>
						<tr>
							<td class="limited-width"><div class="neo-inset p-2 rounded">${sb}</div></td>
    ...
    <div class="row section">
        <div class="col-md-12 neo-surface p-4 p-md-5 rounded-4">
			...
			<div class="neo-surface p-3 mb-4"><table class="table mb-0">
					...
					<tbody>
						<tr>
							<td class="limited-width"><div class="neo-inset p-2 rounded">${pty}</div></td>
				...
				<div class="neo-surface p-3 mb-4"><table class="table mb-0">
						...
						<tbody>
							<tr>
								<td class="limited-width"><div class="neo-inset p-2 rounded">${pcl}</div></td>
					...
					<tbody>
						<tr>
							<td class="limited-width"><div class="neo-inset p-2 rounded">${psb}</div></td>
