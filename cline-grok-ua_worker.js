...
:root {
    ...
    --ukraine-blue-light: rgba(0, 91, 187, 0.1);
    --ukraine-yellow-light: rgba(255, 215, 0, 0.1);
}
...
.ukraine-statement {
    ...
    border-bottom: 3px solid var(--ukraine-blue);
    margin-bottom: 2rem;
}

.ukraine-statement h2 {
    font-size: 2.5rem;
    font-weight: 700;
    margin-bottom: 1rem;
...
.ukraine-table tbody tr:nth-child(even) {
    background: var(--ukraine-blue-light);
}

.ukraine-table tbody tr:nth-child(odd) {
    background: var(--ukraine-yellow-light);
}
...
<div class="ukraine-header">
    <div class="container">
        <h1 class="display-4 fw-bold">🇺🇦 Cloudflare Workers VLESS代理脚本 V25.5.4</h1>
        <p class="lead">乌克兰主题 - 自由与安全的网络连接</p>
    </div>
</div>
...
<div class="ukraine-statement">
    <div class="container">
        <h2>🇺🇦 乌克兰人民在抵抗俄罗斯侵略！</h2>
        <p>我们坚决谴责俄罗斯对乌克兰的野蛮侵略和战争罪行！</p>
        <p>乌克兰人民正在为自由、民主和主权而战！</p>
        <p>全世界应团结起来支持乌克兰的正义事业！</p>
        <div class="hashtags">
            #StandWithUkraine #StopRussianAggression #UkraineWillWin
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="ukraine-section">
        <h3 class="ukraine-section">🌐 CF Workers VLESS+WS节点</h3>
        <div class="ukraine-card p-4">
            <table class="ukraine-table table">
                <thead>
                    <tr>
                        <th>节点特色</th>
                        <th>单节点链接</th>
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">关闭TLS加密，无视域名阻断</td>
                        <td class="limited-width">${w\u0076\u006c\u0065\u0073\u0073ws}</td>
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">📋 复制链接</button></td>
                    </tr>
                </tbody>
            </table>

            <h5 class="mt-4 mb-3 text-primary">客户端参数配置：</h5>
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-unstyled">
                        <li><strong>地址:</strong> 自定义域名/IP</li>
                ...
                <div class="col-md-6">
                    <ul class="list-unstyled">
                        ...
                        <li><strong>TLS:</strong> <span class="text-danger">关闭</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="ukraine-section">
        <h3 class="ukraine-section">🔒 CF Workers VLESS+WS+TLS节点</h3>
        <div class="ukraine-card p-4">
            <table class="ukraine-table table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td class="limited-width">启用TLS加密，支持分片防止域名阻断</td>
                        <td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
                        <td><button class="ukraine-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">📋 复制链接</button></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-unstyled">
                        <li><strong>伪装域名:</strong> ${hostName}</li>
                        <li><strong>路径:</strong> /?ed=2560</li>
                        <li><strong>TLS:</strong> <span class="text-success">开启</span></li>
                        <li><strong>证书验证:</strong> false</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="ukraine-section">
        <h3 class="ukraine-section">📋 订阅链接配置</h3>
        <div class="ukraine-alert">
            <strong>重要提示：</strong><br>
            1. 默认包含TLS+非TLS共13个端口节点<br>
            2. Workers域名订阅需通过代理更新<br>
            3. 不支持分片的客户端无法使用TLS节点
        </div>

        <div class="row">
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    <h6 class="text-primary mb-3">📤 通用分享链接</h6>
                    <button class="ukraine-btn w-100" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">📋 复制分享链接</button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    <h6 class="text-primary mb-3">🔗 通用订阅链接</h6>
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" value="${ty}" readonly>
                        <button class="ukraine-btn" onclick="copyToClipboard('${ty}')">📋</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    <h6 class="text-primary mb-3">⚡ Clash-meta订阅</h6>
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" value="${cl}" readonly>
                        <button class="ukraine-btn" onclick="copyToClipboard('${cl}')">📋</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    <h6 class="text-primary mb-3">📦 Sing-box订阅</h6>
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" value="${sb}" readonly>
                        <button class="ukraine-btn" onclick="copyToClipboard('${sb}')">📋</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="ukraine-header">
    <div class="container">
        <h1 class="display-4 fw-bold">🇺🇦 Cloudflare Pages VLESS代理脚本 V25.5.4</h1>
        <p class="lead">乌克兰主题 - 自由与安全的网络连接</p>
    </div>
</div>
...
<div class="container">
    ...
    <div class="ukraine-section">
        <h3 class="ukraine-section">🔒 CF Pages VLESS+WS+TLS节点</h3>
        <div class="ukraine-card p-4">
            <table class="ukraine-table table">
                <thead>
                    <tr>
    ...
    <div class="ukraine-section">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    <h6 class="text-primary mb-3">📤 通用分享链接</h6>
                    <button class="ukraine-btn w-100" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">📋 复制分享链接</button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <button class="ukraine-btn" onclick="copyToClipboard('${pty}')">📋</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <button class="ukraine-btn" onclick="copyToClipboard('${pcl}')">📋</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ukraine-card p-3 mb-3">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <button class="ukraine-btn" onclick="copyToClipboard('${psb}')">📋</button>
                    </div>
                </div>
            </div>
        </div>
