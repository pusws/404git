...
.tile.green { background: linear-gradient(135deg, #107c10, #0e5c0e); }
.tile.orange { background: linear-gradient(135deg, #ff8c00, #e67c00); }
.tile.red { background: linear-gradient(135deg, #d13438, #a52327); }
.tile.purple { background: linear-gradient(135deg, #881798, #6d1280); }
.tile.teal { background: linear-gradient(135deg, #00bcbc, #009999); }
...
function copyToClipboard(text) {
  ...
  btn.textContent = '已复制!';
  btn.style.background = 'rgba(16, 124, 16, 0.8)';
  setTimeout(() => {
...
<div class="container">
    <div class="header">
        <h1>Cloudflare Workers/Pages VLESS 代理脚本</h1>
        <div class="note">${noteshow}</div>
    </div>
    ...
    <div class="grid">
        <div class="tile green">
            <div class="tile-header">
                ...
                <div class="tile-title">CF-Workers VLESS+WS</div>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <div class="config-text">${w\u0076\u006c\u0065\u0073\u0073ws}</div>
                    <button class="copy-btn" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')">复制链接</button>
                </div>
        ...
        <div class="tile orange">
            <div class="tile-header">
                <div class="tile-icon">🔐</div>
                <div class="tile-title">CF-Workers VLESS+WS+TLS</div>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <div class="config-text">${p\u0076\u006c\u0065\u0073\u0073wstls}</div>
                    <button class="copy-btn" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">复制链接</button>
                </div>
                <ul class="params-list">
                    <li>🌐 地址: 自定义域名 / 优选IP</li>
        ...
        <div class="tile wide-tile red">
            <div class="tile-header">
                <div class="tile-icon">📦</div>
                <div class="tile-title">订阅链接</div>
            </div>
            <div class="tile-content">
                <div class="subscription-grid">
                    <div class="sub-tile">
                        <div class="sub-title">通用分享</div>
                        <button class="copy-btn" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">通用订阅</div>
                        <div class="sub-url">${ty}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${ty}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">Clash Meta</div>
                        <div class="sub-url">${cl}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${cl}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">Sing-box</div>
                        <div class="sub-url">${sb}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${sb}')">复制</button>
                    </div>
                </div>
                <div style="margin-top: 15px; padding: 10px; background: rgba(255,255,255,0.1); font-size: 12px;">
                    ⚠️ 注意：包含TLS+非TLS共13个端口节点，需通过代理订阅更新
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="header">
        <h1>Cloudflare 自定义域 VLESS 订阅与节点</h1>
        <div class="note">${noteshow}</div>
    </div>
    ...
    <div class="grid">
        <div class="tile orange">
            <div class="tile-header">
                <div class="tile-icon">🔐</div>
                <div class="tile-title">VLESS + WS + TLS</div>
            </div>
            <div class="tile-content">
                <div class="config-item">
                    <div class="config-text">${p\u0076\u006c\u0065\u0073\u0073wstls}</div>
        ...
        <div class="tile wide-tile purple">
            <div class="tile-header">
                <div class="tile-icon">📦</div>
                <div class="tile-title">订阅链接（TLS节点）</div>
            </div>
            <div class="tile-content">
                <div class="subscription-grid">
                    <div class="sub-tile">
                        <div class="sub-title">通用分享</div>
                        <button class="copy-btn" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">通用订阅</div>
                        <div class="sub-url">${pty}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${pty}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">Clash Meta</div>
                        <div class="sub-url">${pcl}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${pcl}')">复制</button>
                    </div>
                    <div class="sub-tile">
                        <div class="sub-title">Sing-box</div>
                        <div class="sub-url">${psb}</div>
                        <button class="copy-btn" onclick="copyToClipboard('${psb}')">复制</button>
                    </div>
                </div>
                <div style="margin-top: 15px; padding: 10px; background: rgba(255,255,255,0.1); font-size: 12px;">
                    ⚠️ 注意：以下订阅链接仅包含 6 个 TLS 端口节点
                </div>
            </div>
        </div>
    </div>
